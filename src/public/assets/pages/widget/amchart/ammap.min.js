...
(function () {
    ...
    a.wordwrap = function (i, d, p, o) {
        ...
        for (i = (j = i.split(/\r\n|\n|\r/)).length; ++n < i; j[n] += l) {
            ...
            for (
                ...
                l.length > d;
                j[n] +=
                    a.trim(l.slice(0, m)) + ((l = l.slice(m)).length ? p : '')
            ) {
                m =
                    2 == o || (m = l.slice(0, d + 1).match(/\S*(\s)?$/))[1]
                        ? d
                        : m.input.length - m[0].length ||
                          (1 == o && d) ||
                          m.input.length +
                              (m = l.slice(d).match(/^\S*/))[0].length;
            }
            l = a.trim(l);
        }
        return j.join(p);
    ...
    a.formatDuration = function (r, q, p, o, n, m) {
        ...
        if (r >= j[q].contains) {
            ...
            'ss' == q
                ? ((d = a.formatNumber(d, m)),
                  1 == d.split(i)[0].length && (d = '0' + d))
                : (d = a.roundTo(d, m.precision));
        ...
        if (u) {
            ...
            for (j = 0; j < t.length; j++) {
                var i = t[j],
                    d = u[i];
                void 0 !== d &&
                    ((d = q ? a.addPrefix(d, o, p, s) : a.formatNumber(d, s)),
                    (v = v.replace(
                        new RegExp('\\[\\[' + r + '' + i + '\\]\\]', 'g'),
                        d
                    )));
    ...
    a.processObject = function (g, d, j, i) {
        if (
            !1 === g instanceof d &&
            ((g = i ? a.extend(new d(j), g) : a.extend(g, new d(j), !0)),
            g.listeners)
        ) {
...
(function () {
    ...
    a.SVGRenderer = a.Class({
        ...
        animate: function (h, d, l, k, j) {
            ...
            'translate' == d
                ? ((i = (i = i.getAttribute('transform'))
                      ? String(i).substring(10, i.length - 1)
                      : '0,0'),
                  (i = i.split(', ').join(' ')),
                  (i = i.split(' ').join(',')),
                  0 === i && (i = '0,0'))
                ...
                if (p <= q) {
                    ...
                    if ('translate' == n) {
                        ...
                        d =
                            0 === d - n
                                ? d
                                : Math.round(a[r.effect](0, p, n, d - n, q));
                        r =
                            0 === i - j
                                ? i
                                : Math.round(a[r.effect](0, p, j, i - j, q));
                        n = 'transform';
                        if (isNaN(d) || isNaN(r)) {
                            continue;
                        }
        ...
        pattern: function (v, u, t, s) {
            ...
            a.baseHref &&
                !a.isIE &&
                (o = this.removeTarget(window.location.href) + o);
    ...
    a.AmChart = a.Class({
        ...
        measure: function () {
            ...
            if (h) {
                ...
                this.balloon &&
                    ...
                    this.balloon.setBounds(2, 2, h - 2, i);
                this.updateWidth();
                this.balloon.chart = this;
                this.realWidth = h;
                this.realHeight = i;
        ...
        handleMouseMove: function (h) {
            ...
            if (h) {
                ...
                this.boundingRect &&
                    h.clientX &&
                    ((f = h.clientX - this.boundingRect.left),
                    (l = h.clientY - this.boundingRect.top));
                isNaN(j)
                    ? (this.mouseX = f)
                    : ((this.mouseX = Math.min(f, j)),
                      (this.mouse2X = Math.max(f, j)));
                isNaN(k)
                    ? (this.mouseY = l)
                    ...
                    if (o <= p) {
                        ...
                        0 === j
                            ? (this.animations.splice(i, 1),
                              (n.node.style[m] = Number(d.to) + d.suffix))
                            : (n.node.style[m] = p + d.suffix);
                    } else {
                        (n.node.style[m] = Number(d.to) + d.suffix),
                            (n.animationFinished = !0),
                            this.animations.splice(i, 1);
                    }
                }
            }
    ...
    a.AmBalloon = a.Class({
            ...
            if (!isNaN(al)) {
                ...
                if (this.show) {
                    var af = this.l,
                        ...
                        W = aa;
                    void 0 != ab &&
                        (this.adjustBorderColor ? (W = T = ab) : (aa = ab));
                    ...
                    var Q = ab.offsetWidth,
                        S = ab.offsetHeight;
                    ab.clientHeight &&
                        ((Q = ab.clientWidth), (S = ab.clientHeight));
                    P = S + 2 * s;
                    j = Q + 2 * Y;
                    !isNaN(I) && j < I && (j = I);
                    window.opera && (P += 2);
                    ...
                    'H' != R
                        ...
                        : (2 * X > P && (X = P / 2),
                          (Z = ak - P / 2),
                          al < af + (ad - af) / 2
                              ? ((I = al + X), (this.deltaSignX = -1))
                              : ((I = al - j - X), (this.deltaSignX = 1)));
                    Z + P >= ac && (Z = ac - P);
                    Z < ae && (Z = ae);
                    I < af && (I = af);
                    I + j > ad && (I = ad - j);
                    ...
                    this.drop
                        ? ((af = j / 1.6),
                          ...
                          'left' == R &&
                              ...
                              (Z = ak)),
                          'right' == R &&
                              ((ad = 90), (I = al - af - af / 3 + 2), (Z = ak)),
                          (ae = Z - S / 2 + 1),
                          (ac = I - Q / 2 - 1),
                          (aa = a.drop(ah, af, ad, aa, s, Y, T, d)))
                        : 0 < N || 0 === X
                        ? (0 < O &&
                              ((al = a.rect(ah, j, P, aa, 0, Y + 1, U, O, N)),
                              a.isModern
                                  ? al.translate(1, 1)
                                  : al.translate(4, 4),
                              ag.push(al)),
                        ...
                        : ((W = []),
                          ...
                          0 < O &&
                              ((al = a.polygon(ah, W, N, aa, 0, Y, U, O)),
                              al.translate(1, 1),
                              ag.push(al)),
                    ...
                    this.className &&
                        a.setCN(aj, aa, 'balloon-bg-' + this.className);
        ...
        hide: function (f) {
            ...
            if (0 < f && !d.isHiding) {
                ...
                var g = d.set;
                g &&
                    (g.setAttr('opacity', d.fillAlpha),
                    (d.fadeAnim1 = g.animate({ opacity: 0 }, f, 'easeInSine')));
                d.textDiv &&
                    (d.fadeAnim2 = h.animate(
                        { node: d.textDiv },
                        'opacity',
                        1,
                        0,
...
(function () {
    ...
    a.polygon = function (A, z, y, x, w, v, u, s, q, o, j) {
        ...
        for (var d = 1; d < z.length; d++) {
            o && ((z[d] = a.roundTo(z[d], 5)), (y[d] = a.roundTo(y[d], 5))),
                (s += ' L' + (u(z[d]) + j) + ',' + (u(y[d]) + v));
        }
        A = A.path(s + ' Z').attr(w);
        ...
        for (var u = [], v = [], s = 1; s < y.length; s++) {
            for (
                var r = Number(y[s - 1]),
                    ...
                    i =
                        Math.round(
                            Math.sqrt(Math.pow(o - r, 2) + Math.pow(j - q, 2)) /
                                50
                        ) + 1,
                    o = (o - r) / i,
                    j = (j - q) / i,
    ...
    a.handDrawnLine = function (C, B, A, z, y, x, w, v, u, s) {
        ...
        for (o = 1; o < B.length; o++) {
            for (
                var D = [B[o - 1], B[o]],
                    d = [A[o - 1], A[o]],
                    d = a.makeHD(D, d, C.handDrawScatter),
                    D = d[0],
                    d = d[1],
                    i = 1;
                i < D.length;
    ...
    a.wedge = function (al, ak, aj, ai, ah, ag, af, ae, ad, ac, ab, aa, T, W) {
        ...
        aa &&
            ((S['fill-opacity'] = 0),
            (S['stroke-opacity'] = ac['stroke-opacity'] / 2),
            (S.stroke = ac.stroke));
        if (0 < ad) {
            U = ' M' + R + ',' + (P + ad) + ' L' + Z + ',' + (V + ad);
            X
        ...
        al.handDrawn &&
            ((ae = a.line(
                ...
                [P, V],
                ac.stroke,
                ac.thickness * Math.random() * al.handDrawThickness,
                ac['stroke-opacity']
            )),
            ai.push(ae));
    ...
    a.AmLegend = a.Class({
        ...
        drawLegend: function () {
            ...
            'outside' == d
                ? ((p = m.offsetWidth),
                  (n = m.offsetHeight),
                  m.clientHeight && ((p = m.clientWidth), (n = m.clientHeight)))
                : (isNaN(p) || (m.style.width = p + 'px'),
                  (m.className =
                      'amChartsLegend ' + i.classNamePrefix + '-legend-div'));
            this.divWidth = p;
            (d = this.container)
                ? ((d.container.innerHTML = ''),
                  m.appendChild(d.container),
                  (d.width = p),
                  (d.height = n),
                  d.setSize(p, n),
                  d.addDefs(i))
        ...
        arrangeEntries: function () {
            ...
            if (
                ...
                'center' == this.align
                    ? (Y = U + (P - o.width) / 2)
                    : 'right' == this.align && (Y = U + P - o.width);
            }
            L.translate(Y, Q + 1);
        ...
        createEntry: function (L) {
            if (!1 !== L.visibleInLegend && !L.hideFromLegend) {
                ...
                E &&
                    ...
                    0 < o &&
                    ('x' == E
                        ? ((j = K.createX()), j.translate(o / 2, o / 2))
                        : (j = K.createV()),
                    (j.dItem = L),
                    !0 !== L.hidden
                        ? 'x' == E
        ...
        createValue: function (r) {
            ...
            if (!1 !== r.visibleInLegend && !r.hideFromLegend) {
                ...
                'left' == q.valueAlign &&
                    r.legendLabel &&
                    (n = r.legendLabel.getBBox().width);
                var m = n;
                if (q.valueText && 0 < q.valueWidth) {
                    var j = q.color;
                    q.useMarkerColorForValues &&
                        ((j = r.color),
                        r.legendKeyColor && (j = r.legendKeyColor()));
                ...
                for (t = 0; t < v.length; t++) {
                    ...
                    if (s) {
                        ...
                        if (void 0 !== q.type) {
                            ...
                            q.legendPeriodValueText &&
                                (j = q.legendPeriodValueText);
                            q.legendPeriodValueTextR &&
                                (j = q.legendPeriodValueTextR);
                            o
                                ? ((p = this.valueText),
                                  q.legendValueText && (p = q.legendValueText),
                                  q.legendValueTextR &&
                                      (p = q.legendValueTextR),
                        ...
                        this.useMarkerColorForLabels &&
                            ...
                            (o = q.lastDataItem);
                        o
                            ? (d = u.getBalloonColor(q, o))
                            : q.legendKeyColor && (d = q.legendKeyColor());
                        q.legendColorFunction &&
                            (d = q.legendColorFunction(
                                j,
                                p,
                                q.periodDataItem,
                                q.periodPercentDataItem
                            ));
                        r.text(p);
                        if (
                            !q.pattern &&
...
(function () {
    ...
    a.AmMap = a.Class({
        ...
        drawChart: function () {
            ...
            this.areasSettings = a.processObject(
                this.areasSettings,
                a.AreasSettings,
                this.theme
            );
            this.imagesSettings = a.processObject(
                this.imagesSettings,
                a.ImagesSettings,
                this.theme
            );
            this.linesSettings = a.processObject(
                this.linesSettings,
                a.LinesSettings,
                this.theme
            );
        ...
        buildEverything: function () {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.projectionFunction ||
                    (this.projectionFunction = a.equirectangular);
                this.dpProjectionFunction = a[d.projection];
                this.dpProjectionFunction ||
                    (this.dpProjectionFunction = a.equirectangular);
                this.zoomControl = a.processObject(
                    this.zoomControl,
                    a.ZoomControl,
                    this.theme
                );
                ...
                this.drawBg();
                this.buildSVGMap();
                (this.projectionFunction && f != d.projection) ||
                this.forceNormalize
                    ? (this.normalizeMap(), this.changeProjection())
                    : this.fixMapPosition();
                if ((f = this.smallMap)) {
                    (f = a.processObject(f, a.SmallMap, this.theme)),
                        f.init(this, e),
                        (this.smallMap = f);
                }
                isNaN(d.zoomX) &&
                ...
                if ((d = this.valueLegend)) {
                    (this.valueLegend = d =
                        a.processObject(d, a.ValueLegend, this.theme)),
                        d.init(this, e);
                }
                this.objectList &&
                    (e = this.objectList =
                        a.processObject(this.objectList, a.ObjectList)) &&
        ...
        makeObjectAccessible: function (d) {
            if (d.accessibleLabel) {
                ...
                d.displayObject &&
                    this.makeAccessible(d.displayObject, c, 'menuitem');
            }
        },
        update: function () {
            if (a.hasSVG) {
                ...
                if ((f = this.dataProvider.areas)) {
                    for (k = 0; k < f.length; k++) {
                        ...
                        i &&
                            i.setAttr(
                                'stroke-width',
                                l.outlineThicknessReal / h / this.mapScale
                            );
                    }
                }
            }
        ...
        rescaleObjects: function () {
            ...
            for (l = 0; l < e.length; l++) {
                var k = e[l].image,
                    j = e[l].scale,
                    i = e[l].mapImage;
                isNaN(i.selectedScaleReal) ||
                    i != this.selectedObject ||
                    ((i.tempScale = j), (j *= i.selectedScaleReal));
            ...
            if (a.isModern) {
                ...
                if (!f.preventHover) {
                    ...
                    ((f.mouseIsOver && !f.mapWasDragged && !f.skipClick) ||
                        (f.wasTouched &&
                            3 > Math.abs(f.mouseX - f.tmx) &&
                            3 > Math.abs(f.mouseY - f.tmy))) &&
                        f.fire({
                            type: 'click',
                            x: f.mouseX,
                            y: f.mouseY,
                    ...
                    f.zoomOnDoubleClick &&
                        f.mouseIsOver &&
                        ((d = new Date().getTime()),
                        200 > d - f.previousClickTime &&
                            40 < d - f.previousClickTime &&
                            f.doDoubleClickZoom(),
        ...
        handleMouseMove: function (E) {
            ...
            if (!E || !E.touches || !D.tapToActivate || D.tapped) {
                ...
                E &&
                    ...
                    D.panEventsEnabled &&
                    D.boundingRect &&
                    ((D.mouse2X = E.clientX - D.boundingRect.left),
                    (D.mouse2Y = E.clientY - D.boundingRect.top));
                if ((E = D.mapContainer)) {
                    var v = D.mouse2X,
                        u = D.mouse2Y;
                    ...
                    D.mouseIsDown &&
                        D.dragMap &&
                        (3 < Math.abs(D.previuosMouseX - D.mouseX) ||
                            3 < Math.abs(D.previuosMouseY - D.mouseY)) &&
                        (D.isDragging = !0);
                    if (!isNaN(v)) {
                        D.stopDrag();
                        var d = Math.sqrt(
                                Math.pow(v - z, 2) + Math.pow(u - x, 2)
                            ),
                            i = D.initialDistance;
                        isNaN(i) &&
                            (i = Math.sqrt(
                    ...
                    D.isDragging &&
                        ...
                        isNaN(B) ||
                            isNaN(A) ||
                            (E.translate(B, A, v, !0), D.updateSmallMap()));
                    D.previuosMouseX = z;
                    D.previuosMouseY = x;
                }
            }
        ...
        selectObject: function (x, w) {
            ...
            'MapArea' == x.objectType &&
                (x.autoZoomReal && (s = !0),
                (r = v.areasSettings.selectedOutlineColor),
                (q = v.areasSettings.selectedOutlineThickness));
            if (
                u &&
                !s &&
                (a.isString(u) && (u = v.getObjectById(u)),
                isNaN(x.zoomLevel) && isNaN(x.zoomX) && isNaN(x.zoomY))
            ) {
            ...
            !s && isNaN(x.zoomLevel) && isNaN(x.zoomX) && isNaN(x.zoomY)
                ...
                : ((v.selectedObjectTimeOut = setTimeout(function () {
                      v.showDescriptionAndGetUrl.call(v);
                  }, 1000 * u + 200)),
                  v.showObjectsAfterZoom)
                ? w ||
                  (v.processObjectsTimeOut = setTimeout(function () {
            ...
            if (u) {
                if (
                    ...
                    'MapLine' == x.objectType &&
                        ((o = x.lineSvg) && o.setAttr('stroke', s),
                        (o = x.arrowSvg)) &&
                        (o.setAttr('fill', s), o.setAttr('stroke', s));
                    if ((o = x.imageLabel)) {
                        (j = x.selectedLabelColorReal),
                            void 0 !== j && o.setAttr('fill', j);
                    }
                    x.selectable ||
                        (u.setAttr('cursor', 'default'),
                        o && o.setAttr('cursor', 'default'));
                }
            } else {
            ...
            if ((u = x.groupId)) {
                for (
                    o = x.groupArray,
                        o || ((o = v.getGroupById(u)), (x.groupArray = o)),
                        j = 0;
                    j < o.length;
                    j++
                ) {
                    if (
                        ...
                        (i.isOver = !1),
                        (u = i.displayObject),
                        'MapImage' == i.objectType && (u = i.image),
                        u)
                    ) {
                        ...
                        'MapLine' == i.objectType &&
                            ((u = i.lineSvg) && u.setAttr('stroke', s),
                            (u = i.arrowSvg)) &&
            ...
            if (q) {
                ...
                if (r.showAsSelected) {
                    ...
                    'MapImage' == r.objectType &&
                        ((i = this.imagesSettings.selectedOutlineColor),
                        (d = this.imagesSettings.selectedOutlineThickness));
                    'MapArea' == r.objectType &&
                        ((i = this.areasSettings.selectedOutlineColor),
                        (d = this.areasSettings.selectedOutlineThickness));
                    void 0 !== i && (j = i);
                    void 0 !== d && (m = d);
                }
                ...
                'MapArea' == r.objectType &&
                    ...
                    this.areasSettings.adjustOutlineThickness &&
                        (p = this.zoomLevel() * this.mapScale),
                    q.setAttr('stroke', j),
        ...
        zoomToStageXY: function (h, d, l, k) {
            if (!this.objectWasClicked) {
                ...
                d = this.xyToCoordinates(
                    (d - this.mapContainer.x) / j - i.x * this.mapScale,
                    (l - this.mapContainer.y) / j - i.y * this.mapScale
                );
        ...
        zoomToMapXY: function (h, e, l, k) {
            ...
            this.zoomTo(
                h,
                -(e / j) * h + this.realWidth / j / 2,
                -(l / i) * h + this.realHeight / i / 2,
                k
            );
        },
        zoomToObject: function (r) {
            if (r) {
                ...
                'MapArea' == r.objectType &&
                    ...
                    (n = n.height * m),
                    (i =
                        r.autoZoomReal && isNaN(r.zoomLevel)
                            ? o / i > n / d
                                ? (0.8 * i) / o
                                : (0.8 * d) / n
                            : r.zoomLevel),
                    ...
                    isNaN(r.zoomX) &&
                        ...
                        isNaN(r.zoomLatitude) &&
                        isNaN(r.zoomLongitude) &&
                        this.zoomToMapXY(i, q + o / 2, p + n / 2));
                this.zoomControl.update();
            }
        },
        ...
        zoomTo: function (g, d, j, i) {
            ...
            h = this.zoomLevel();
            isNaN(d) &&
                ((d = this.realWidth / this.mapWidth),
                (d = (this.zoomX() - 0.5 * d) * (g / h) + 0.5 * d));
            isNaN(j) &&
                ((j = this.realHeight / this.mapHeight),
                (j = (this.zoomY() - 0.5 * j) * (g / h) + 0.5 * j));
            this.stopAnimation();
            isNaN(g) ||
                ((h = this.mapContainer),
                (this.initialX = h.x),
        ...
        processObjects: function (h) {
            ...
            if (
                ...
                this.linesAboveImages
                    ? (j.toFront(), l.toFront(), i.toFront(), k.toFront())
                    : (i.toFront(), k.toFront(), j.toFront(), l.toFront());
                e &&
        ...
        addObjectEventListeners: function (e, d) {
            ...
            e.mousedown(function (b) {
                ...
                .touchend(function (b) {
                    4 > Math.abs(f.mouseX - f.tmx) &&
                        4 > Math.abs(f.mouseY - f.tmy) &&
                        (f.tapped = !0);
        ...
        showAsRolledOver: function (g) {
            ...
            if (!g.showAsSelected && d && !g.isOver) {
                ...
                !g.isFirst &&
                    g.bringForwardOnHover &&
                    (d.toFront(), (g.isFirst = !0));
                var j = g.rollOverColorReal,
                    i;
                g.preserveOriginalAttributes && (j = void 0);
                'bubble' == g.type && (j = void 0);
                void 0 == j &&
                    (isNaN(g.rollOverBrightnessReal) ||
                        (j = a.adjustLuminosity(
                            g.colorReal,
                            g.rollOverBrightnessReal / 100
                        )));
                if (void 0 != j) {
                    if ('MapImage' == g.objectType) {
                        ...
                        if ('MapLine' == g.objectType) {
                            if (
                                ((i = g.lineSvg) && i.setAttr('stroke', j),
                                (i = g.arrowSvg))
                            ) {
                ...
                (j = g.imageLabel) &&
                    !g.labelInactive &&
                    ((i = g.labelRollOverColorReal),
                    void 0 != i && j.setAttr('fill', i));
                j = g.rollOverOutlineColorReal;
                void 0 != j &&
                    ('MapImage' == g.objectType
                        ? (i = g.image) && i.setAttr('stroke', j)
                        : d.setAttr('stroke', j));
                'MapImage' == g.objectType
                    ? ((j = this.imagesSettings.rollOverOutlineThickness),
                      (i = g.image) &&
                          (isNaN(j) || i.setAttr('stroke-width', j)))
                    : ((j = this.areasSettings.rollOverOutlineThickness),
                      isNaN(j) || d.setAttr('stroke-width', j));
                ...
                'MapImage' == g.objectType &&
                    ...
                    isNaN(j) ||
                        ...
                        isNaN(i) && (i = 1),
                        (g.tempScale = i),
                        d.translate(d.x, d.y, i * j, !0)));
                this.useHandCursorOnClickableOjects &&
                    this.checkIfClickable(g) &&
        ...
        rollOverMapObject: function (g, e, j) {
            if (this.chartCreated) {
                ...
                i && i != g
                    ? (!1 === this.checkIfSelected(i) &&
                          (this.returnInitialColor(i, !0),
                    ...
                    if (!1 === this.checkIfSelected(g)) {
                        ...
                        (i = g.displayObject) &&
                            (this.allowClickOnSelectedObject
                                ...
                                : i.setAttr('cursor', 'default'));
                    }
                    this.showDescriptionOnHover
                        ? this.showDescription(g)
                        : (!this.showBalloonOnSelectedObject &&
                              this.checkIfSelected(g)) ||
                          !1 === e ||
                          ((h = this.balloon),
                          (this.balloon.fixedPosition = !1),
                          (e = g.colorReal),
                          (i = ''),
                          (void 0 !== e && this.useObjectColorForBalloon) ||
                              (e = h.fillColor),
                          (h = g.balloonTextReal) &&
                              (i = this.formatString(h, g)),
                          this.balloonLabelFunction &&
                              (i = this.balloonLabelFunction(g, this)),
                          i &&
                              '' !== i &&
                              this.showBalloon(
                                  i,
        ...
        longitudeToX: function (b) {
            return (
                (this.longitudeToCoordinate(b) + this.diffX * this.mapScale) *
                    this.zoomLevel() +
                this.mapContainer.x
            );
        },
        latitudeToY: function (b) {
            return (
                (this.latitudeToCoordinate(b) + this.diffY * this.mapScale) *
                    this.zoomLevel() +
                this.mapContainer.y
            );
        },
        latitudeToStageY: function (b) {
            return (
                this.latitudeToCoordinate(b) * this.zoomLevel() +
                this.mapContainer.y +
        ...
        longitudeToStageX: function (b) {
            return (
                this.longitudeToCoordinate(b) * this.zoomLevel() +
                this.mapContainer.x +
        ...
        clickMapObject: function (g, e) {
            ...
            e &&
                (e.touches ||
                    (isNaN(g.zoomLevel) && isNaN(g.zoomX) && isNaN(g.zoomY)) ||
                    j.hideBalloon());
            if (
                j.chartCreated &&
                !j.preventHover &&
                j.checkTouchDuration(e) &&
                !j.mapWasDragged &&
                j.checkIfClickable(g) &&
                !j.mapWasPinched
            ) {
                j.selectObject(g);
                var i = j.zoomLevel(),
                    h = j.mapSet.getBBox(),
                    i = j.xyToCoordinates(
                        (j.mouseX - j.mapContainer.x) / i - h.x * j.mapScale,
                        (j.mouseY - j.mapContainer.y) / i - h.y * j.mapScale
                    );
        ...
        showBalloonAfterZoom: function () {
            ...
            'MapImage' != f.objectType ||
                isNaN(f.longitude) ||
                ((e = f.longitude), (d = f.latitude));
        ...
        zoomX: function () {
            return this.mapSet
                ? Math.round((10000 * this.mapContainer.x) / this.mapWidth) /
                      10000
                : NaN;
        },
        zoomY: function () {
            return this.mapSet
                ? Math.round((10000 * this.mapContainer.y) / this.mapHeight) /
                      10000
                : NaN;
        },
        goHome: function () {
                ...
                if (d) {
                    ...
                    if ((d = e.linkToObject)) {
                        ...
                        d &&
                            ...
                            ((d.zoomLatitude = this.zoomLatitude()),
                            (d.zoomLongitude = this.zoomLongitude()),
        ...
        showDescription: function (r) {
            ...
            if (r.description) {
                ...
                isNaN(n) &&
                    ((n = this.mouseX),
                    (n = n > this.realWidth / 2 ? n - p - 20 : n + 20));
        ...
        recalcLongitude: function (b) {
            return this.dataProvider.wrappedLongitudes
                ? b < this.dataProvider.leftLongitude
                    ? Number(b) + 360
                    : b
                : b;
        },
        ...
        longitudeToCoordinate: function (e) {
            ...
            this.mapSet &&
                ((d = f.leftLongitude),
                (d = ((e - d) / (f.rightLongitude - d)) * this.mapWidth));
            return d;
        },
        mercatorLatitudeToCoordinate: function (b) {
            ...
            return a.radiansToDegrees(
                (0.5 * Math.log((1 + Math.sin(b)) / (1 - Math.sin(b)))) / 2
            );
        },
        ...
        getAreaCenterLatitude: function (e) {
            ...
            return this.xyToCoordinates(
                (e.x + e.width / 2 + this.diffX) * d - f.x * d,
                (e.y + e.height / 2 + this.diffY) * d - f.y * d
            ).latitude;
        },
        ...
        milesToPixels: function (d) {
            ...
            return (
                ((this.mapWidth / (c.rightLongitude - c.leftLongitude)) * d) /
                69.172
            );
        },
        ...
        getDevInfo: function () {
            var d = this.zoomLevel(),
                ...
                c = this.xyToCoordinates(
                    (this.mouseX - this.mapContainer.x) / d -
                        c.x * this.mapScale,
                    (this.mouseY - this.mapContainer.y) / d -
                        c.y * this.mapScale
                ),
                d = {
                    chart: this,
                ...
                c =
                    c +
                    ('left:' + d.percentLeft + ', top:' + d.percentTop + '\n'),
                c =
                    c +
                    ('right:' +
                        d.percentRight +
        ...
        processObject: function (g, d, j) {
            if (g) {
                ...
                for (i = 0; i < g.length; i++) {
                    ...
                    'image' == j &&
                        (h = a.extend(h, new a.MapImage(this.theme), !0));
                    'line' == j &&
                        (h = a.extend(h, new a.MapLine(this.theme), !0));
                    g[i] = h;
        ...
        x2c: function (d) {
            ...
            return (
                Math.round(
                    ((this.unscaledMapWidth * (d - c)) /
                        (this.dataProvider.rightLongitude - c)) *
                        100
                ) / 100
            );
        },
        y2c: function (d) {
            ...
            return (
                Math.round(
                    ((this.unscaledMapHeight * (d - c)) /
                        (this.dataProvider.bottomLatitude - c)) *
                        100
                ) / 100
            );
        },
        ...
        redrawArea: function (i) {
            for (var d = !1, p = '', o = 0; o < i.length; o++) {
                ...
                l < this.minMapXX &&
                    ((this.minMapXX = l),
                    (this.leftLongLat = { longitude: n, latitude: m }));
                l > this.maxMapXX &&
                    ((this.maxMapXX = l),
                    (this.rightLongLat = { longitude: n, latitude: m }));
                j < this.minMapYY &&
                    ((this.minMapYY = j),
                    (this.topLongLat = { longitude: n, latitude: m }));
                j > this.maxMapYY &&
                    ((this.maxMapYY = j),
                    (this.bottomLongLat = { longitude: n, latitude: m }));
                d ? (p += ' L ') : ((p += ' M '), (d = !0));
                p += l + ' ' + j;
            }
            return p + ' Z ';
        ...
        fixMapPosition: function () {
            ...
            s = this.coordinatesToXY(
                a.radiansToDegrees(p),
                a.radiansToDegrees(r)
            );
            t = this.coordinatesToXY(
                a.radiansToDegrees(t),
                a.radiansToDegrees(o)
            );
            r = o = Infinity;
            for (q = 0; q < this.svgAreas.length; q++) {
                (p = this.svgAreas[q].getBBox()),
                    p.y < o && (o = p.y),
                    p.x < r && (r = p.x);
            }
        ...
        coordinatesToXY: function (f, d) {
            ...
            h = !1;
            this.dataProvider &&
                (h = this.dataProvider.wrappedLongitudes) &&
                (f = this.recalcLongitude(f));
            this.projectionFunction
                ? ((g = this.projectionFunction(
                      a.degreesToRadians(f),
                      a.degreesToRadians(d)
                  )),
                  (h =
                      this.mapScale *
                      a.roundTo(this.x2c(a.radiansToDegrees(g[0])), 3)),
                  (g =
                      this.mapScale *
                      a.roundTo(this.y2c(a.radiansToDegrees(g[1])), 3)))
                : ((h = this.longitudeToCoordinate(f)),
                  (g = this.latitudeToCoordinate(d)));
            return { x: h, y: g };
        },
        ...
        stageXYToCoordinates: function (f, e) {
            var h = this.mapSet.getBBox(),
                g =
                    (f - this.mapContainer.x) / this.zoomLevel() -
                    h.x * this.mapScale,
                h =
        ...
        xyToCoordinates: function (x, w, v, u, t) {
            ...
            if ((s = v.invert)) {
                var r = this.dataProvider.leftLongitude,
                    ...
                    i = r + (q - r) / 2,
                    d = o + (j - o) / 2,
                    o = a.radiansToDegrees(
                        v(a.degreesToRadians(i), a.degreesToRadians(o))[1]
                    ),
                    j = a.radiansToDegrees(
                        v(a.degreesToRadians(i), a.degreesToRadians(j))[1]
                    ),
                    r = a.radiansToDegrees(
                        v(a.degreesToRadians(r), a.degreesToRadians(d))[0]
                    ),
                    q = a.radiansToDegrees(
                        v(a.degreesToRadians(q), a.degreesToRadians(d))[0]
                    );
                this.projectionChanged &&
                    ((o = a.radiansToDegrees(
                        v(
                            a.degreesToRadians(this.topLongLat.longitude),
                            a.degreesToRadians(this.topLongLat.latitude)
                        )[1]
                    )),
                    (j = a.radiansToDegrees(
                        v(
                            a.degreesToRadians(this.bottomLongLat.longitude),
                            a.degreesToRadians(this.bottomLongLat.latitude)
                        )[1]
                    )),
                    (r = a.radiansToDegrees(
                        v(
                            a.degreesToRadians(this.leftLongLat.longitude),
                            a.degreesToRadians(this.leftLongLat.latitude)
                        )[0]
                    )),
                    (q = a.radiansToDegrees(
                        v(
                            a.degreesToRadians(this.rightLongLat.longitude),
                            a.degreesToRadians(this.rightLongLat.latitude)
                        )[0]
                    )));
                ...
                (s = this.coordinateToLongitude(x)),
                    (w = this.coordinateToLatitude(w));
            }
            ...
            if (this.mapSet) {
                ...
                'mercator' == i.projection
                    ? ((i = this.mercatorLatitudeToCoordinate(h)),
                      ...
                      (j = a.radiansToDegrees(
                          2 * Math.atan(Math.exp(j)) - 0.5 * Math.PI
                      )))
                    : (j = (g / d) * (h - j) + j);
            }
        ...
        coordinateToLongitude: function (f, e) {
            ...
            this.mapSet &&
                (h =
                    (f / e) * (g.rightLongitude - g.leftLongitude) +
                    g.leftLongitude);
    ...
    a.ZoomControl = a.Class({
        ...
        init: function (af, ae) {
            ...
            var ab = ad.buttonSize,
                ...
                d = af.getY(ad.top);
            isNaN(ad.right) ||
                ((j = af.getX(ad.right, !0)), (j = Z ? j - 3 * ab : j - ab));
            isNaN(ad.bottom) ||
                ((d = af.getY(ad.bottom, !0)),
                aa && (d -= S + 3 * ab),
                (d = Z
                    ? d - 3 * ab
            ...
            if (aa) {
                ...
                5 < S &&
                    ((aa = a.rect(
                        ...
                        ab + 6,
                        S + 2 * ab + 6,
                        ad.gridBackgroundColor,
                        ad.gridBackgroundAlpha,
                        0,
                        '#000000',
                        0,
                        4
                ...
                d = new a.SimpleButton();
                P
                    ? (d.svgIcon = a.line(ae, [-j, j], [0, 0], J, s, 1))
                    : d.setIcon(af.pathToImages + 'minus.gif', ad.iconSize);
            ...
            ad.homeButtonEnabled &&
                ...
                ad.panControlEnabled
                    ? Z.set.translate(ab, ab)
                    : K && K.translate(0, 1.5 * ab),
            ...
            j &&
                (this.isDragging
                    ? (j.stopDrag(),
                      ...
                      j.zoomTo(
                          100 * Math.pow(i, n - (k - l) / d),
                          NaN,
                          NaN,
                          !0
                      ))
                    : ((i = Math.log(j.zoomLevel() / 100) / Math.log(i)),
                      (k = (n - i) * d + l)),
                (this.previousY = j.mouseY),
                this.previousDY != k &&
                    m &&
                    (m.translate((this.buttonSize - this.draggerSize) / 2, k),
                    (this.previousDY = k)));
        },
    });
})();
(function () {
    ...
    a.SimpleButton = a.Class({
        ...
        init: function (C, B, A, z, y, x, w, v, u, s, o, j, D) {
            ...
            D
                ? ((B /= 2),
                  (z = a.circle(C, B, z, y, x, w, v)),
                  z.translate(B, B))
                : (z = a.rect(C, B, A, z, y, x, w, v, u));
            s.push(z);
            y = d.iconPath;
            var i;
            y &&
                ...
                (x = (B - i) / 2),
                D && (x = (2 * B - i) / 2),
                (i = C.image(y, x, (A - i) / 2, i, i)));
            d.svgIcon &&
                ((i = d.svgIcon),
                D ? i.translate(B, B) : i.translate(B / 2, B / 2));
            s.setAttr('cursor', 'pointer');
            i &&
                (s.push(i),
                i.setAttr('opacity', o),
                (i.node.style.pointerEvents = 'none'));
    ...
    a.SmallMap = a.Class({
        ...
        init: function (C, B) {
            ...
            if (A.enabled) {
                ...
                isNaN(A.bottom) ||
                    ((u = C.getY(A.bottom, !0) - A.height - x),
                    (i = A.height - v + x / 2));
                isNaN(A.left) || ((s = C.getX(A.left) + x), (d = -x / 2));
                isNaN(A.right) ||
                    ((s = C.getX(A.right, !0) - A.width - x),
                    (d = A.width - v + x / 2));
                x = B.set();
                ...
                a.remove(A.allSet),
                    a.remove(A.downButtonSet),
                    a.remove(A.upButtonSet);
            }
        },
        minimize: function () {
        ...
        buildSVGMap: function () {
            ...
            var m = -d.y * p,
                ...
                j = 0;
            i.centerMap &&
                ((l = (this.width - d.width * p) / 2),
                (j = (this.height - d.height * p) / 2));
        ...
        update: function () {
            ...
            if (i) {
                var e = i.zoomLevel(),
                    ...
                    j = this.rectangle;
                j.translate(
                    -(i.mapContainer.x + k.x * e) * l + this.dx,
                    -(i.mapContainer.y + k.y * e) * l + this.dy
                );
                0 < n &&
                    0 < m &&
                    (j.setAttr('width', Math.ceil(n + 1)),
                    j.setAttr('height', Math.ceil(m + 1)));
                this.rWidth = n;
                this.rHeight = m;
            }
        },
        ...
        handleMouseUp: function () {
            ...
            d.zoomToMapXY(
                c,
                (d.mouseX - this.set.x - this.mapX) / this.size +
                    d.diffX * d.mapScale,
                (d.mouseY - this.set.y - this.mapY) / this.size +
                    d.diffY * d.mapScale
            );
        },
    });
    ...
    a.AreasProcessor = a.Class({
        ...
        updateAllAreas: function () {
            ...
            for (i = 0; i < r.length; i++) {
                ...
                if (x.preserveOriginalAttributes) {
                    ...
                    x.adjustOutlineThickness &&
                        (z = z / y.zoomLevel() / y.mapScale);
                    o.setAttr('stroke-width', z);
                }
                a.setCN(y, o, 'map-area-unlisted');
                q.getAreasFromMap &&
                    !j[o.id] &&
                    ((z = new a.MapArea(y.theme)),
                    (z.parentObject = q),
                    (z.id = o.id),
                    (z.outline = o.outline),
                    q.areas.push(z));
        ...
        createArea: function (R) {
            ...
            void 0 == O.colorSolid ||
                isNaN(R.value) ||
                ((E = Math.floor(
                    (R.value - this.minValue) /
                        ((this.maxValue - this.minValue) / Q.colorSteps)
                )),
                E == Q.colorSteps && E--,
                (E *= 1 / (Q.colorSteps - 1)),
            ...
            void 0 == R.preserveOriginalAttributes &&
                (R.preserveOriginalAttributes = j);
            isNaN(O.selectedBrightness) ||
                (D = a.adjustLuminosity(
                    R.colorReal,
            ...
            if (
                ...
                void 0 != R.colorReal &&
                    (x =
                        R.showAsSelected || Q.selectedObject == R
                            ? R.selectedColorReal
                            : R.colorReal);
...
(function () {
    ...
    a.ImagesProcessor = a.Class({
        ...
        createImage: function (af, ae) {
            ...
            af.colorReal = I;
            isNaN(Z.selectedBrightness) ||
                (W = a.adjustLuminosity(
                    af.colorReal,
                    Z.selectedBrightness / 100
                ));
            af.alphaReal = Y;
            ...
            M = af.height;
            s = af.scale;
            isNaN(af.percentWidth) ||
                (P = (af.percentWidth / 100) * ad.realWidth);
            isNaN(af.percentHeight) ||
                (M = (af.percentHeight / 100) * ad.realHeight);
            var O;
            ...
            if (V) {
                isNaN(P) && (P = 10);
                isNaN(M) && (M = 10);
                'kilometers' == af.widthAndHeightUnits &&
                    ((P = ad.kilometersToPixels(af.width)),
                    (M = ad.kilometersToPixels(af.height)));
                'miles' == af.widthAndHeightUnits &&
                    ((P = ad.milesToPixels(af.width)),
                    (M = ad.milesToPixels(af.height)));
                ...
                S = K = 0;
                af.centeredReal
                    ? (isNaN(af.right) || (K = P * s),
                      isNaN(af.bottom) || (S = M * s))
                    : ((K = (P * s) / 2), (S = (M * s) / 2));
                O.translate(K, S, s, !0);
            } else {
                L
                    ? (isNaN(P) && (P = 10),
                      ...
                      O.setAttr('opacity', Y),
                      af.centeredReal &&
                          ((K = isNaN(af.right) ? -P / 2 : P / 2),
                          (S = isNaN(af.bottom) ? -M / 2 : M / 2),
                          O.translate(K, S, NaN, !0)))
                    : R &&
                      ((O = ac.path(R)),
                      (L = O.getBBox()),
                      af.centeredReal
            ...
            I = af.labelColorReal;
            (!af.showAsSelected && ad.selectedObject != af) ||
                void 0 == Z ||
                (O && O.setAttr('fill', Z), (I = af.selectedLabelColorReal));
            O = null;
            void 0 !== af.label &&
                ((O = a.text(
                    ac,
                ...
                (Y = af.labelBackgroundColor) &&
                    ...
                    void 0 != af.id &&
                        a.setCN(ad, ac, 'map-image-label-background-' + af.id),
                    o.push(ac),
                    (af.labelBG = ac)),
                (af.imageLabel = O),
                o.push(O),
                ...
                void 0 != af.id &&
                    a.setCN(ad, o, 'map-image-container-' + af.id),
            ...
            af.lineId &&
                (O = this.chart.getObjectById(af.lineId)) &&
                0 < O.longitudes.length &&
                (ac = !1);
            ...
            af.animateAlongLine &&
                (ad.updatableImages.push(af), af.delayAnimateAlong());
            return af;
        },
        ...
        positionLabel: function (t, s, r) {
            if (t) {
                ...
                s.labelBG &&
                    s.labelBG.translate(
                        p - q.width / 2 + s.labelShiftX - 9,
                        o - t / 2 + s.labelShiftY - 4,
                        NaN,
                        !0
                    );
            }
    ...
    a.LinesProcessor = a.Class({
        ...
        createLine: function (aw, av) {
            ...
            if (aw.remainVisible || au.selectedObject == aw.parentObject) {
                ...
                aw.colorReal = an;
                aw.arrowColor = am;
                isNaN(at.selectedBrightness) ||
                    (ac = a.adjustLuminosity(
                        aw.colorReal,
                        at.selectedBrightness / 100
                    ));
                aw.alphaReal = ai;
                ...
                void 0 == aw.bringForwardOnHover &&
                    (aw.bringForwardOnHover = af);
                ...
                if (0 < aj) {
                    for (af = [], Y = [], ag = 0; ag < aj; ag++) {
                        (Z = au.coordinatesToXY(al[ag], at[ag])),
                            af.push(Z.x),
                            Y.push(Z.y);
                    }
                }
                if (0 < af.length) {
                    ...
                    if (isNaN(aj)) {
                        for (aj = 0; aj < af.length - 1; aj++) {
                            (T = Math.sqrt(
                                Math.pow(af[aj + 1] - af[aj], 2) +
                                    Math.pow(Y[aj + 1] - Y[aj], 2)
                            )),
                                (aw.distances[aj] = T);
                        }
                    ...
                    if ('none' != aa) {
                        ...
                        'both' == aa &&
                            ...
                            void 0 != aw.id &&
                                a.setCN(au, aj, 'map-line-arrow-' + aw.id),
                        ...
                        isNaN(S) || ah.rotate(S);
                        aw.fixedSize &&
                            (ar.push(ah), aw.arrays.push({ arr: ar, el: ah }));
                        aw.arrowSvg = ah;
                    }
                    aw.fixedSize &&
                        aj &&
        ...
        getCoordinates: function (x, w) {
            ...
            if (!isNaN(x)) {
                ...
                if (1 < this.longitudes.length) {
                    u = this.chart.coordinatesToXY(
                        this.longitudes[w],
                        this.latitudes[w]
                    );
                    var o = this.chart.coordinatesToXY(
                        this.longitudes[w + 1],
                        this.latitudes[w + 1]
                    );
                    v = u.x;
                ...
                if (!isNaN(this.arc) && 0 !== this.arc && this.arcRadius) {
                    ...
                    r =
                        v +
                        (t - v) / 2 +
                        (Math.sqrt(q * q - (o / 2) * (o / 2)) * (u - s)) / o;
                    var d =
                        u +
                        (s - u) / 2 +
                        (Math.sqrt(q * q - (o / 2) * (o / 2)) * (t - v)) / o;
        ...
        fixToStage: function () {
            if (0 < this.latitudes.length) {
                ...
                for (var d = 0; d < this.latitudes.length; d++) {
                    var c = this.chart.coordinatesToStageXY(
                        this.longitudes[d],
                        this.latitudes[d]
                    );
                    this.y.push(c.y);
        ...
        fixToMap: function () {
            if (0 < this.y.length) {
                ...
                for (var d = 0; d < this.y.length; d++) {
                    var c = this.chart.stageXYToCoordinates(
                        this.x[d],
                        this.y[d]
                    );
    ...
    a.MapImage = a.Class({
        ...
        animate: function () {
            ...
            this.line &&
                ...
                (this.line.distances &&
                    ...
                    (c = Math.abs(c / d.baseAnimationDistance))),
        ...
        delayAnimateAlong: function () {
            this.animateAlongLine &&
                (this.delayCounter =
                    this.chart.imagesSettings.pauseDuration * a.updateRate);
        },
        fixToStage: function () {
...
(function () {
    ...
    a.hex2RGB = function (b) {
        return [
            parseInt(b.substring(1, 3), 16),
            parseInt(b.substring(3, 5), 16),
            parseInt(b.substring(5, 7), 16),
        ];
    };
    a.processDescriptionWindow = function (d, c) {
        isNaN(c.descriptionWindowX) &&
            (c.descriptionWindowX = d.descriptionWindowX);
        isNaN(c.descriptionWindowY) &&
            (c.descriptionWindowY = d.descriptionWindowY);
        isNaN(c.descriptionWindowLeft) &&
            (c.descriptionWindowLeft = d.descriptionWindowLeft);
        isNaN(c.descriptionWindowRight) &&
            (c.descriptionWindowRight = d.descriptionWindowRight);
        isNaN(c.descriptionWindowTop) &&
            (c.descriptionWindowTop = d.descriptionWindowTop);
        isNaN(c.descriptionWindowBottom) &&
            (c.descriptionWindowBottom = d.descriptionWindowBottom);
        isNaN(c.descriptionWindowWidth) &&
            (c.descriptionWindowWidth = d.descriptionWindowWidth);
        isNaN(c.descriptionWindowHeight) &&
            (c.descriptionWindowHeight = d.descriptionWindowHeight);
    };
    a.normalizePath = function (y) {
        for (
            var x = '',
                w = a.parsePath(y.getAttribute('d')),
                v,
                u,
                s = Infinity,
                r = -Infinity,
    ...
    a.eckert6 = function (h, e) {
        for (
            var l = Math.PI, k = (1 + l / 2) * Math.sin(e), j = 0, i = Infinity;
            10 > j && 0.00001 < Math.abs(i);
            j++
        ) {
    ...
    a.eckert6.invert = function (f, d) {
        var h = 1 + Math.PI / 2,
            g = Math.sqrt(h / 2);
        return [
            (2 * f * g) / (1 + Math.cos((d *= g))),
            a.asin((d + Math.sin(d)) / h),
        ];
    };
...
(function () {
    ...
    a.DescriptionWindow = a.Class({
        ...
        show: function (r, q, p, o) {
            ...
            e.className =
                'ammapDescriptionWindowCloseButton ' + j + 'close-img';
...
(function () {
    ...
    a.ObjectList = a.Class({
        ...
        init: function (d) {
            ...
            c.className =
                'ammapObjectList ' + d.classNamePrefix + '-object-list-div';
        ...
        addObjects: function (h, e) {
            ...
            if (h.areas) {
                for (j = 0; j < h.areas.length; j++) {
                    var i = h.areas[j];
                    void 0 === i.showInList &&
                        (i.showInList = l.showAreasInList);
                    this.addObject(i, k);
                }
            }
            if (h.images) {
                for (j = 0; j < h.images.length; j++) {
                    (i = h.images[j]),
                        void 0 === i.showInList &&
                            (i.showInList = l.showImagesInList),
                        this.addObject(i, k);
                }
            }
            if (h.lines) {
                for (j = 0; j < h.lines.length; j++) {
                    (i = h.lines[j]),
                        void 0 === i.showInList &&
                            (i.showInList = l.showLinesInList),
                        this.addObject(i, k);
                }
            }
