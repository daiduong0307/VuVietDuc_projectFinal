...
(function () {
    ...
    d.AmDraw = d.Class({
        ...
        rect: function (a, b, c, e, f, g, h) {
            ...
            d.VML &&
                ((f = Math.round((100 * f) / Math.min(c, e))),
                (c += 2 * g),
                (e += 2 * g),
                (k.bw = g),
...
(function () {
    ...
    d.SVGRenderer = d.Class({
        ...
        animate: function (a, b, c, e, f) {
            ...
            'translate' == b
                ? ((g = (g = g.getAttribute('transform'))
                      ? String(g).substring(10, g.length - 1)
                      : '0,0'),
                  (g = g.split(', ').join(' ')),
                  (g = g.split(' ').join(',')),
                  0 === g && (g = '0,0'))
                : (g = Number(g.getAttribute(b)));
            c = {
                obj: a,
                frame: 0,
                attribute: b,
                ...
                if (f <= e) {
                    ...
                    'translate' == h
                        ? ((l = c.to.split(',')),
                          ...
                          (l = Number(l[1])),
                          g.translate(m, l))
                        : ((k = Number(c.to)), this.setAttr(g, h, k)),
        ...
        clipRect: function (a, b, c, e, f) {
            ...
            var k = g.parentNode;
            k &&
                ((g = document.createElementNS(d.SVG_NS, 'clipPath')),
                (h = d.getUniqueId()),
                g.setAttribute('id', h),
            ...
            if (a) {
                if (a.touches) {
                    ...
                    g &&
                        this.panEventsEnabled &&
                        this.boundingRect &&
                        ((e = g.clientX - this.boundingRect.left),
    ...
    d.handDrawnLine = function (a, b, c, e, f, g, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (
                var t = [b[n - 1], b[n]],
                    r = [c[n - 1], c[n]],
                    r = d.makeHD(t, r, a.handDrawScatter),
                    t = r[0],
                    r = r[1],
                    q = 1;
                q < t.length;
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) g.value ? f.text(g.value) : f.text('');
                        ...
                        this.useMarkerColorForLabels &&
                            ...
                            (k = g.lastDataItem);
                        k
                            ? (n = b.getBalloonColor(g, k))
                            : g.legendKeyColor && (n = g.legendKeyColor());
                        g.legendColorFunction &&
                            (n = g.legendColorFunction(
                                l,
                                h,
                                g.periodDataItem,
    ...
    d.AmMap = d.Class({
        ...
        rescaleObjects: function () {
            ...
            for (c = 0; c < b.length; c++) {
                var d = b[c].image,
                    f = b[c].scale,
                    g = b[c].mapImage;
                isNaN(g.selectedScaleReal) ||
                    g != this.selectedObject ||
                    ((g.tempScale = f), (f *= g.selectedScaleReal));
            ...
            if (!a || !a.touches || !b.tapToActivate || b.tapped) {
                ...
                if ((a = b.mapContainer)) {
                    ...
                    b.isDragging &&
                        ...
                        (e = a.y + (g - e)),
                        b.preventDragOut &&
                            ((t = -t * k + m / 2 - b.diffY * b.mapScale * k),
            ...
            if (b) {
                ...
                if (a.showAsSelected) {
                    ...
                    'MapImage' == a.objectType &&
                        ((k = this.imagesSettings.selectedOutlineColor),
                        (l = this.imagesSettings.selectedOutlineThickness));
                    'MapArea' == a.objectType &&
                        ((k = this.areasSettings.selectedOutlineColor),
            ...
            if (a) {
                ...
                'MapArea' == a.objectType &&
                    ...
                    isNaN(a.zoomX) &&
                        ...
                        isNaN(a.zoomLatitude) &&
                        isNaN(a.zoomLongitude) &&
                        this.zoomToMapXY(k, b + e / 2, c + f / 2));
        ...
        zoomTo: function (a, b, c, e) {
            ...
            isNaN(b) &&
                ...
                (b = (this.zoomX() - 0.5 * b) * (a / f) + 0.5 * b));
            isNaN(c) &&
                ((c = this.realHeight / this.mapHeight),
                (c = (this.zoomY() - 0.5 * c) * (a / f) + 0.5 * c));
            this.stopAnimation();
            isNaN(a) ||
                ((f = this.mapContainer),
                (this.initialX = f.x),
        ...
        processObjects: function (a) {
            ...
            if (
                ...
                this.linesAboveImages
                    ? (f.toFront(), c.toFront(), g.toFront(), d.toFront())
                    : (g.toFront(), d.toFront(), f.toFront(), c.toFront());
                b &&
            ...
            for (var c = 0; c < b.length; c++) {
                ...
                if (d) {
                    for (var d = d.split('L'), f = [], g = 0; g < d.length; g++)
                        if (d[g]) {
                            var h = d[g].split(' '),
                                h = this.xyToCoordinates(
                                    Number(h[1]) - this.minMapX,
    ...
    d.ZoomControl = d.Class({
        ...
        init: function (a, b) {
            ...
            if (g) {
                ...
                z = new d.SimpleButton();
                C
                    ? (z.svgIcon = d.line(b, [-x, x], [0, 0], v, w, 1))
        ...
        update: function () {
            ...
            h &&
                ...
                this.previousDY != g &&
                    e &&
                    (e.translate((this.buttonSize - this.draggerSize) / 2, g),
                    (this.previousDY = g)));
        },
    });
})();
            ...
            if (n) {
                ...
                u
                    ? (isNaN(C) && (C = 10),
                      ...
                      D.setAttr('opacity', k),
                      a.centeredReal &&
                          ((F = isNaN(a.right) ? -C / 2 : C / 2),
                          (q = isNaN(a.bottom) ? -E / 2 : E / 2),
                          D.translate(F, q, NaN, !0)))
                    : B &&
                      ((D = e.path(B)),
                      (u = D.getBBox()),
                      a.centeredReal
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < v.length) {
                    ...
                    if (isNaN(q)) {
                        ...
                        l = d.line(x, v, C, l, 0.001, 5 / n, k, !1, !1, !0);
                    ...
                    a.fixedSize &&
                        q &&
                        ((f = { line: q, thickness: F }),
                        this.linesToResize.push(f),
                        a.arrays.push({ arr: this.linesToResize, el: f }),
                        (f = { line: l, thickness: 5 }),
                        this.linesToResize.push(f),
                        a.arrays.push({ arr: this.linesToResize, el: f }));
                    a.lineSvg = q;
...
(function () {
    ...
    d.winkel3.invert = function (a, b) {
        ...
        do
            var h = Math.cos(e),
                ...
                y = 0.5 * (2 * B * h * r + c / g) - a,
                w = 0.5 * (B * k + e) - b,
                v = 0.5 * u * (n * q + B * h * t * m) + 0.5 / g,
                A = u * ((p * l) / 4 - B * k * r),
                k = 0.125 * u * (l * r - B * k * n * p),
                m = 0.5 * u * (m * t + B * q * h) + 0.5,
                h = A * k - m * v,
                A = (w * A - y * m) / h,
                y = (y * k - w * v) / h,
                c = c - A,
                e = e - y;
        while ((1e-6 < Math.abs(A) || 1e-6 < Math.abs(y)) && 0 < --f);
        return [c, e];
    };
    ...
    d.eckert6 = function (a, b) {
        for (
            var c = Math.PI, d = (1 + c / 2) * Math.sin(b), f = 0, g = Infinity;
            10 > f && 1e-5 < Math.abs(g);
            f++
        )
