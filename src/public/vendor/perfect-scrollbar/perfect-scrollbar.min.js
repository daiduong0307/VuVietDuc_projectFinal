...
!(function (t, e) {
    ...
    function h(t, e, i, n) {
        ...
        f &&
            ...
            f > 0
                ? d.dispatchEvent(c('ps-scroll-' + h))
                : d.dispatchEvent(c('ps-scroll-' + u)),
            p || (d[o] = e),
            t.reach[s] &&
                d.dispatchEvent(c('ps-' + s + '-reach-' + t.reach[s])),
            n && a(t, s));
    }
    function u(t) {
    ...
    (Y.prototype.bind = function (t, e) {
        ...
        (Y.prototype.unbind = function (t, e) {
            ...
            this.handlers[t] = this.handlers[t].filter(function (n) {
                return (
                    !(!e || n === e) ||
                    (i.element.removeEventListener(t, n, !1), !1)
                );
            });
        }),
            ...
            keyboard: function (t) {
                function e(e, n) {
                    ...
                    if (0 === n) {
                        ...
                        if (
                            (0 === l && e < 0) ||
                            (l >= t.contentWidth - t.containerWidth && e > 0)
                        )
                            return !t.settings.wheelPropagation;
                    }
                    return !0;
                ...
                var i = t.element,
                    ...
                    l = function () {
                        return (
                            n(t.scrollbarX, ':focus') ||
                            n(t.scrollbarY, ':focus')
                        );
                    };
            ...
            touch: function (t) {
                function e(e, i) {
                    ...
                    if (o > l) {
                        ...
                        l > o &&
                        ((e < 0 && r === t.contentWidth - t.containerWidth) ||
                            (e > 0 && 0 === r))
                    )
                        return {
                            stop: !t.settings.swipePropagation,
                ...
                function a(n) {
                    if (
                        (!g && t.settings.swipePropagation && s(n),
                        !b && g && o(n))
                    ) {
                        var r = l(n),
