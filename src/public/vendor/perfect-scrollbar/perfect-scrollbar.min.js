...
!(function (t, e) {
    ...
    function h(t, e, i, n) {
        var r = i[0],
            ...
            p = !1;
        (t.reach[s] = null),
            e <= 0 && ((e = 0), (t.reach[s] = 'start')),
            e >= t[r] - t[l] && ((e = t[r] - t[l]) - d[o] <= 2 && (p = !0), (t.reach[s] = 'end'));
        var f = d[o] - e;
        f &&
            (d.dispatchEvent(c('ps-scroll-' + s)),
    ...
    function b(t, i) {
        ...
        i.isRtl
            ? (n.left =
                  i.negativeScrollAdjustment + t.scrollLeft + i.containerWidth - i.contentWidth)
            : (n.left = t.scrollLeft),
            i.isScrollbarXUsingBottom
                ? (n.bottom = i.scrollbarXBottom - t.scrollTop)
                : (n.top = i.scrollbarXTop + t.scrollTop),
    ...
    var y = function (t, e, i, n) {
        ...
        L = function (t) {
            ...
            (t.containerWidth = e.clientWidth),
                ...
                e.contains(t.scrollbarXRail) ||
                    (l(e, m.element.rail('x')).forEach(function (t) {
                        return r(t);
                    }),
                    e.appendChild(t.scrollbarXRail)),
                e.contains(t.scrollbarYRail) ||
                    (l(e, m.element.rail('y')).forEach(function (t) {
                        return r(t);
                    }),
            ...
            wheel: function (e) {
                function i(t, i) {
                    ...
                    if (0 === t) {
                        ...
                        if (
                            (0 === n && i > 0) ||
                            (n >= e.contentHeight - e.containerHeight && i < 0)
                        )
                ...
                function r(e, i, n) {
                    ...
                    for (var r = e; r && r !== o; ) {
                        ...
                        if (
                            ...
                            if (
                                s > 0 &&
                                !((0 === r.scrollTop && n > 0) || (r.scrollTop === s && n < 0))
                            )
                                return !0;
                            var a = r.scrollLeft - r.clientWidth;
                            if (
                                a > 0 &&
                                !((0 === r.scrollLeft && i < 0) || (r.scrollLeft === a && i > 0))
                            )
                                return !0;
                        }
                        r = r.parentNode;
                    ...
                    if (!r(t.target, s, a)) {
                        ...
                        e.settings.useBothWheelAxes
                            ? e.scrollbarYActive && !e.scrollbarXActive
                                ? (a
                                      ? y(e, 'top', o.scrollTop - a * e.settings.wheelSpeed)
                                      : y(e, 'top', o.scrollTop + s * e.settings.wheelSpeed),
                                  (c = !0))
                                : e.scrollbarXActive &&
                                  !e.scrollbarYActive &&
                                  (s
                                      ? y(e, 'left', o.scrollLeft + s * e.settings.wheelSpeed)
                                      : y(e, 'left', o.scrollLeft - a * e.settings.wheelSpeed),
                                  (c = !0))
                            : (y(e, 'top', o.scrollTop - a * e.settings.wheelSpeed),
                              y(e, 'left', o.scrollLeft + s * e.settings.wheelSpeed)),
                            L(e),
                            (c = c || i(s, a)) && (t.stopPropagation(), t.preventDefault());
                    }
                }
                var o = e.element;
                void 0 !== window.onwheel
                    ? e.event.bind(o, 'wheel', l)
                    : void 0 !== window.onmousewheel && e.event.bind(o, 'mousewheel', l);
            },
            touch: function (t) {
                function e(e, i) {
                    var n = h.scrollTop,
                    ...
                    if (o > l) {
                        ...
                        l > o &&
                        ((e < 0 && r === t.contentWidth - t.containerWidth) || (e > 0 && 0 === r))
                    )
                        return {
                            stop: !t.settings.swipePropagation,
                            prevent: !0,
                            ...
                            (f = setInterval(function () {
                                t.isInitialized
                                    ...
                                    ? Math.abs(p.x) < 0.01 && Math.abs(p.y) < 0.01
                                        ? clearInterval(f)
                                        : (i(30 * p.x, 30 * p.y), (p.x *= 0.8), (p.y *= 0.8))
                                    : clearInterval(f);
                            }, 10))));
                }
        ...
        T = function (n, r) {
            ...
            (this.scrollbarYRight = parseInt(h.right, 10)),
                isNaN(this.scrollbarYRight)
                    ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = u(h.left)))
        ...
        E = { isInitialized: { configurable: !0 } };
    return (
        (E.isInitialized.get = function () {
        ...
        (T.prototype.update = function () {
            this.isInitialized &&
                ...
                (this.railXMarginWidth =
                    u(t(this.scrollbarXRail).marginLeft) + u(t(this.scrollbarXRail).marginRight)),
                (this.railYMarginHeight =
                    u(t(this.scrollbarYRail).marginTop) + u(t(this.scrollbarYRail).marginBottom)),
