    ...
    (function () {
        AmCharts.export = function (a, b) {
            var c,
                d = {
                        ...
                        handler: {
                            ...
                            redo: function (a, b) {
                                ...
                                (d.drawing.enabled = !1),
                                    ...
                                    d.setup.wrapper &&
                                        (d.setup.chart.containerDiv.removeChild(
                                            d.setup.wrapper
                                        ),
                                        (d.setup.wrapper = !1));
                            },
                            ...
                            change: function (a, b, c) {
                                ...
                                if (
                                    ...
                                    e.opacity &&
                                        (d.drawing.opacity = e.opacity),
                                    (h = d.getRGBA(d.drawing.color)),
                                    h.pop(),
                                    h.push(d.drawing.opacity),
                                    (d.drawing.color =
                                        'rgba(' + h.join() + ')'),
                                    (d.setup.fabric.freeDrawingBrush.color =
                                        d.drawing.color),
                                    (d.setup.fabric.freeDrawingBrush.width =
                                        d.drawing.width),
                                    i)
                                ) {
                                    for (
                            ...
                            line: function (a) {
                                ...
                                if (
                                    ...
                                    if (b.arrow) {
                                        ...
                                        return (
                                            ...
                                            'change' == b.action &&
                                                d.setup.fabric.setActiveObject(
                                                    i
                                                ),
                                ...
                                for (c = 0; c < b.group.length; c++)
                                    d.setup.fabric.add(b.group[c]);
                                return b;
                            },
                        },
                    },
                    ...
                    loadResource: function (a, b) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                d.libs.reload && document.head.removeChild(g),
                                    (e = !0);
                                break;
                            }
                    ...
                    isHashbanged: function (a) {
                        ...
                        return (
                            'url' == b.slice(0, 3) &&
                            b.slice(b.indexOf('#') + 1, b.length - 1)
                        );
                    },
                    ...
                    removeImage: function (a) {
                        if (a) {
                            ...
                            if (d.config.fabric.removeImages && d.isTainted(a))
                                return !0;
                            if (
                                d.setup.isIE &&
                                (10 == d.setup.IEversion ||
                                    11 == d.setup.IEversion) &&
                        ...
                        for (e = 0; e < a.children.length; e++) {
                            ...
                            if ('clipPath' == g.tagName) {
                                ...
                                for (f = 0; f < g.childNodes.length; f++)
                                    g.childNodes[f].setAttribute(
                                        'fill',
                                        'transparent'
                                    ),
                                        (h = {
                                            x: d.pxToNumber(
                                                g.childNodes[f].getAttribute(
                                                    'x'
                                                )
                                            ),
                                            y: d.pxToNumber(
                    ...
                    gatherPosition: function (a, b) {
                        var f,
                            ...
                            e = fabric.util.invertTransform(
                                d.setup.fabric.viewportTransform
                            );
                        return (
                            'touchmove' == a.type &&
                                ('touches' in a
                    ...
                    capture: function (a, b) {
                        ...
                        var j =
                            d.setup.chart.containerDiv.getElementsByTagName(
                                'svg'
                            );
                            ...
                            for (c = 0; c < i.items.length; c++) {
                                var l = i.items[c],
                                    k = {
                                        ...
                                        parent: l.container.container
                                            .parentNode,
                                        children:
                                            l.container.container.getElementsByTagName(
                                                '*'
                                            ),
                                        offset: { x: 0, y: 0 },
                                        legend: {
                        ...
                        if (
                            ((d.drawing.enabled = e.drawing.enabled =
                                'draw' == e.action),
                            ...
                            d.setup.chart.containerDiv.appendChild(
                                d.setup.wrapper
                            ),
                            ...
                            d.setup.chart.leftContainer &&
                                ...
                                d.setup.chart.dataSetSelector &&
                                    ...
                                    (m[
                                        ...
                                        d.setup.chart.dataSetSelector.offsetHeight)),
                                (d.setup.wrapper.style.paddingTop =
                                    d.numberToPx(m.top)),
                                (d.setup.wrapper.style.paddingRight =
                                    d.numberToPx(m.right)),
                                (d.setup.wrapper.style.paddingBottom =
                                    d.numberToPx(m.bottom)),
                                (d.setup.wrapper.style.paddingLeft =
                                    d.numberToPx(m.left));
                        }
                        for (
                            d.setup.canvas = document.createElement('canvas'),
                                ...
                                d.deepMerge(
                                    d.setup.fabric.freeDrawingBrush,
                                    e.drawing
                                ),
                                ...
                                d.setup.fabric.on('mouse:down', function (a) {
                                    ...
                                    (d.drawing.buffer.pressedTS = Number(
                                        new Date()
                                    )),
                                        d.isPressed(a.e),
                                        (d.drawing.buffer.isDrawing = !1),
                                        (d.drawing.buffer.isDrawingTimer =
                                            setTimeout(function () {
                                    ...
                                    if (
                                        ...
                                        d.drawing.buffer.isPressed &&
                                            ...
                                            !d.drawing.buffer.line &&
                                                ...
                                                (b.xD > 5 || b.yD > 5) &&
                                                ((d.setup.fabric.isDrawingMode =
                                                    !1),
                                                (d.setup.fabric._isCurrentlyDrawing =
                                                    !1),
                                ...
                                d.setup.fabric.on('mouse:up', function (a) {
                                    if (!d.drawing.buffer.isDrawing) {
                                        ...
                                        b &&
                                            b.selectable &&
                                            d.setup.fabric.setActiveObject(b);
                                    }
                                    if (d.drawing.buffer.line) {
                                        for (
                                            c = 0;
                                            c <
                                            d.drawing.buffer.line.group.length;
                                            c++
                                        )
                                            d.drawing.buffer.line.group[
                                                c
                                            ].remove();
                                ...
                                d.drawing.enabled
                                    ? (d.setup.wrapper.setAttribute(
                                          'class',
                                          d.setup.chart.classNamePrefix +
                                              '-export-canvas active'
                                      ),
                                      (d.setup.wrapper.style.backgroundColor =
                                          e.backgroundColor),
                            ...
                            d.setup.chart.legendSettings.position
                                ? ['top', 'bottom'].indexOf(
                                    ...
                                    ? k.parent.style.top && k.parent.style.left
                                        ? ((k.offset.y = d.pxToNumber(
                                              k.parent.style.top
                                          )),
                                          (k.offset.x = d.pxToNumber(
                                              k.parent.style.left
                                          )))
                                        : ((k.offset.x = g.x),
                                          (k.offset.y = g.y),
                                          (g.y += d.pxToNumber(
                                              k.parent.style.height
                                          )),
                                          k.has.panel
                                              ? ((g.pY = d.pxToNumber(
                                                    k.has.panel.style.marginTop
                                                )),
                                                (k.offset.y += g.pY))
                                              : k.has.scrollbar &&
                                                (k.offset.y += g.pY))
                                    : ['left', 'right'].indexOf(
                                      ...
                                      ((k.offset.y =
                                          d.pxToNumber(k.parent.style.top) +
                                          g.pY),
                                      (k.offset.x =
                                          d.pxToNumber(k.parent.style.left) +
                                          g.pX),
                                      k.has.legend
                                          ? (g.pY +=
                                                d.pxToNumber(
                                                    k.has.panel.style.height
                                                ) +
                                                d.setup.chart.panelsSettings
                                                    .panelSpacing)
                                          : k.has.scrollbar &&
                                ...
                                : ('absolute' == k.parent.style.position
                                      ? ((k.offset.absolute = !0),
                                        (k.offset.top = d.pxToNumber(
                                            k.parent.style.top
                                        )),
                                        (k.offset.right = d.pxToNumber(
                                            k.parent.style.right,
                                            !0
                                        )),
                                        (k.offset.bottom = d.pxToNumber(
                                            k.parent.style.bottom,
                                            !0
                                        )),
                                        (k.offset.left = d.pxToNumber(
                                            k.parent.style.left
                                        )),
                                        (k.offset.width = d.pxToNumber(
                                            k.parent.style.width
                                        )),
                                        (k.offset.height = d.pxToNumber(
                                            k.parent.style.height
                                        )))
                                      : k.parent.style.top &&
                                        k.parent.style.left
                                    ...
                                    (function (a) {
                                        return function (c, i) {
                                            ...
                                            if (
                                                ...
                                                var q =
                                                    a.svg.parentNode.getElementsByClassName(
                                                        d.setup.chart
                                                            .classNamePrefix +
                                                            '-balloon-div'
                                                    );
                                                for (j = 0; j < q.length; j++)
                                                    if (
                                                        e.balloonFunction instanceof
                                                        Function
                                                    )
                                                        e.balloonFunction.apply(
                                                            d,
                                                            [q[j], a]
                                                        );
                                                    else {
                    ...
                    toSVG: function (a, b) {
                        ...
                        if (
                            ...
                            return !1;
                        if (
                            ((g = d.setup.fabric.toSVG(f, f.reviver)), c.length)
                        ) {
                        ...
                        return (
                            ...
                            f.getBase64 &&
                                (g = 'data:image/svg+xml;base64,' + btoa(g)),
                    ...
                    toJSON: function (a, b) {
                        var c = d.deepMerge(
                                {
                                    dateFormat:
                                        d.config.dateFormat || 'dateObject',
                                },
                                a || {},
                                !0
                            ),
                        ...
                        return (
                            ...
                            ((c.data =
                                void 0 !== c.data ? c.data : d.getChartData(c)),
                    ...
                    toXLSX: function (a, b) {
                        function h(a, b) {
                            ...
                            return (
                                (c - d - new Date(Date.UTC(1899, 11, 30))) /
                                864e5
                            );
                        }
                        function i(a, b) {
                            ...
                            return (
                                d.s.c < 1e7 &&
                                    (c['!ref'] = XLSX.utils.encode_range(d)),
                                c
                            );
                        }
                        var c = d.deepMerge(
                    ...
                    toArray: function (a, b) {
                        function k(a, b) {
                            var c =
                                b.exportFields || Object.keys(b.dataFieldsMap);
                    ...
                    handleBorder: function (a) {
                        if (d.config.border instanceof Object) {
                            ...
                            (b.width = d.setup.fabric.width - b.strokeWidth),
                                (b.height =
                                    d.setup.fabric.height - b.strokeWidth),
                                c.set(b),
                                d.setup.fabric.add(c);
                        }
                    },
                    ...
                    getChartData: function (a) {
                        function j(a, e, f) {
                            function g(a, c) {
                                return b.dataFields.indexOf(a) != -1
                                    ? g([a, '.', c].join(''))
                                    : a;
                            }
                            a &&
                        ...
                        if (0 == b.data.length)
                            if ('stock' == d.setup.chart.type) {
                                for (
                                    b.data = d.cloneObject(
                                        d.setup.chart.mainDataSet.dataProvider
                                    ),
                                        j(
                                            d.setup.chart.mainDataSet
                                                .categoryField
                                        ),
                                        b.dateFields.push(
                                            d.setup.chart.mainDataSet
                                        ...
                                        e = 0;
                                    e <
                                    d.setup.chart.mainDataSet.fieldMappings
                                        .length;
                                    e++
                                ) {
                                    var k =
                                    ...
                                    for (
                                        f = 0;
                                        f < d.setup.chart.panels.length;
                                        f++
                                    ) {
                                        var l = d.setup.chart.panels[f];
                                        for (
                                            g = 0;
                                            g < l.stockGraphs.length;
                                            g++
                                        ) {
                                ...
                                if (d.setup.chart.comparedGraphs.length) {
                                    ...
                                    for (
                                        e = 0;
                                        e < d.setup.chart.comparedGraphs.length;
                                        e++
                                    ) {
                                        var m = d.setup.chart.comparedGraphs[e];
                                        for (
                                            f = 0;
                                            f < m.dataSet.dataProvider.length;
                                            f++
                                        ) {
                                            var n = m.dataSet.categoryField,
                                                o =
                                                    m.dataSet.dataProvider[f][
                                                        n
                                                    ],
                                                p = i.indexOf(o);
                                            if (p != -1)
                                ...
                                for (
                                    e = 0;
                                    e < d.setup.chart.dataProvider.length;
                                    e++
                                ) {
                                ...
                                ['pie', 'funnel'].indexOf(d.setup.chart.type) !=
                                -1
                            )
                        ...
                        return (
                            fabric.util.enlivenObjects(c.data, function (a) {
                                a.forEach(function (a, b) {
                                    d.handleCallback(c.reviver, a, b),
                    ...
                    processData: function (b) {
                        ...
                        if (c.data.length) {
                            ...
                            void 0 !== c.exportFields &&
                                (c.dataFields = c.exportFields.filter(function (
                                    a
                                ) {
                    ...
                    createMenu: function (b, c) {
                                ...
                                if (
                                    ...
                                    if ('draw' == j.action)
                                        ...
                                        j.click ||
                                            j.menu ||
                                            j.items ||
                                            (d.drawing.handler[o] instanceof
                                            Function
                                                ? ((j.action = o),
                                                  (j.click = (function (a) {
                                                      return function () {
                                    ...
                                    (void 0 === j.menu || j.menu.length) &&
                                        ...
                                        j.title &&
                                            l.setAttribute('title', j.title),
                                        d.config.menuReviver &&
                                            (k = d.config.menuReviver.apply(d, [
                                                j,
                                                k,
                                            ])),
                                        (j.elements = {
                                        ...
                                        (j.menu || j.items) &&
                                        'draw' != j.action
                                            ? g(j.menu || j.items, k).childNodes
                                                  .length && i.appendChild(k)
                                            : i.appendChild(k));
                                }
                            }
                        ...
                        return (
                            ...
                            d.setup.menu.childNodes.length &&
                                c.appendChild(d.setup.menu),
                            d.setup.menu
                        );
                    },
                    delay: function (a, b) {
                            ...
                            ((d.docListener = function (b) {
                                ...
                                function i(a) {
                                    d.setup.focusedMenuItem &&
                                        ...
                                        (d.setup.focusedMenuItem.parentNode.classList.add(
                                            'active'
                                        ),
                                        h(
                                ...
                                function j(a) {
                                    d.setup.focusedMenuItem &&
                                        d.setup.focusedMenuItem.parentNode
                                ...
                                var c = d.drawing.buffer.target,
                                    ...
                                    g =
                                        (['top-left', 'bottom-left'].indexOf(
                                            d.config.position
                                        ) != -1,
                                        ['top-right', 'bottom-right'].indexOf(
                                            d.config.position
                                        ) != -1);
                                if (
                                    d.setup.focusedMenuItem &&
                                    e.indexOf(b.keyCode) != -1
                                ) {
                                    if (9 == b.keyCode)
                                        return void (d.setup.focusedMenuItem
                                            .nextSibling
                                            ? b.shiftKey &&
                                              d.setup.focusedMenuItem.parentNode.classList.remove(
                                                  'active'
                                ...
                                (8 != b.keyCode && 46 != b.keyCode) || !c
                                    ? 27 == b.keyCode && d.drawing.enabled
                                        ...
                                        : 88 == b.keyCode &&
                                          ...
                                          c
                                        ? ((d.drawing.buffer.copy = c),
                                          d.setup.fabric.remove(c))
                                        : 86 == b.keyCode &&
                                          (b.metaKey || b.ctrlKey)
                                        ? d.drawing.buffer.copy &&
                                          a(d.drawing.buffer.copy.clone(a))
                                        : 90 == b.keyCode &&
                                          (b.metaKey || b.ctrlKey) &&
                                          (b.preventDefault(),
                                          b.shiftKey
                            ...
                            (c = setInterval(function () {
                                d.setup &&
                                    ...
                                    d.config.enabled &&
                                        ...
                                        d.config.overflow &&
                                            (d.setup.chart.div.style.overflow =
                                                'visible'),
                                        d.loadListeners(),
                                        d.createMenu(d.config.menu),
                    ...
                    construct: function () {
                        ...
                        (window.safari = window.safari ? window.safari : {}),
                            ...
                            d.libs.path ||
                                (d.libs.path = d.config.path + 'libs/'),
                            d.isSupported() &&
                                (d.loadDependencies(
                                    d.libs.resources,
                                    d.libs.reload
            ...
            if (b) d.config = b;
                ...
                if (!d.setup.chart.amExport && !d.setup.chart.exportConfig)
                    return;
