...
(function () {
    ...
    e.AmSerialChart = e.Class({
        ...
        getEndTime: function (a) {
            ...
            return (
                e.changeDate(new Date(a), b.period, b.count, !0).getTime() - 1
            );
        },
        updateMargins: function () {
            ...
            if ((b = this.valueAxes))
                (b = b[0]),
                    isNaN(b.relativeStart) ||
                        (0 !== e.roundTo(b.relativeStart, 3) && (a = !0),
                            ...
                            for (h = d.length - 1; 0 <= h; h--)
                                if (
                                    ...
                                    if (
                                        b.showNextAvailable &&
                                        isNaN(k.y) &&
                                        ((k = this.getNextItem(k)), !k)
                                    )
                                        continue;
                                    k = k.y;
                                    'top' == f.showBalloonAt && (k = 0);
                                    'bottom' == f.showBalloonAt &&
                                        (k = this.height);
                                    var p = b.mouseX,
                                        n = b.mouseY;
                                    k = this.rotate
                        ...
                        if (
                            ...
                            for (h = 0; h < d.length; h++) {
                                ...
                                if (
                                    b.showNextAvailable &&
                                    isNaN(k.y) &&
                                    ((k = this.getNextItem(k)), !k && f.balloon)
                                ) {
                                    f.balloon.hide();
                                    continue;
                                }
                    ...
                    if (
                        ...
                        for (
                            q = Math.floor(f / k),
                                ...
                                this.end - f + 1 >= this.autoRotateCount &&
                                    (this.labelRotationR =
                            ...
                            B &&
                                ...
                                ((a =
                                    'right' == this.position
                                        ? c.marginRight - this.titleWidth
                                        : c.marginLeft - this.titleWidth),
                ...
                if (this.widthField)
                    for (b = this.start; b <= this.end; b++)
                        (t = this.data[b]),
                            ...
                            this.rotate
                                ? ((m = (this.height * d) / y / 2 + l),
                                  (l = (this.height * d) / y + l))
                                : ((m = (this.width * d) / y / 2 + l),
                                  (l = (this.width * d) / y + l)),
                            (t.x[this.id] = m);
                    ...
                    if (
                        ...
                        l.toDate &&
                            ...
                            this.equalSpacing
                                ...
                                : (d =
                                      (l.toDate.getTime() - this.startTime) *
                                      this.stepWidth),
                            (p = new this.axisItemRenderer(
                                this,
                                d,
