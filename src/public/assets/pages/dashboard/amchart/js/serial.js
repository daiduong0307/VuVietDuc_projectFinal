    ...
    f.AmRectangularChart = f.Class({
        ...
        measureMargins: function () {
            ...
            for (m = 0; m < a.length; m++)
                a[m].handleSynchronization(),
                    (b = this.getAxisBounds(a[m], e, k, f, b)),
                    (e = Math.round(b.l)),
                    (k = Math.round(b.r)),
                    (f = Math.round(b.t)),
                    (b = Math.round(b.b));
            if ((a = this.categoryAxis))
                (b = this.getAxisBounds(a, e, k, f, b)),
                    (e = Math.round(b.l)),
                    (k = Math.round(b.r)),
                    (f = Math.round(b.t)),
                    (b = Math.round(b.b));
            d.left &&
                e < c &&
                ((this.marginLeft = Math.round(-e + c)),
                !isNaN(this.minMarginLeft) &&
                    this.marginLeft < this.minMarginLeft &&
                    (this.marginLeft = this.minMarginLeft));
            d.right &&
                k >= g - c &&
                ((this.marginRight = Math.round(k - g + c)),
        ...
        drawZoomOutButton: function () {
            ...
            if (!a.zbSet) {
                ...
                void 0 !== e &&
                    ((c = f.text(a.container, e, c, a.fontFamily, d, 'start')),
                    f.setCN(a, c, 'zoom-out-label'),
                    (d = c.getBBox()),
        ...
        updateChartCursor: function () {
            var a = this.chartCursor;
            a &&
                ((a = f.processObject(a, f.ChartCursor, this.theme)),
    ...
    f.AmSerialChart = f.Class({
                ...
                0 > a
                    ? d
                        ? ((f = this.endTime - this.startTime),
                          ...
                          (g = this.endTime + e * g),
                          0 < e && 0 < h && g >= c && ((g = c), (d = c - f)),
                          this.zoomToDates(new Date(d), new Date(g)))
                        : (0 < e && 0 < h && this.end >= f - 1 && (h = e = 0),
                          (d = this.start + h),
                          (g = this.end + e),
                    ...
                    ? ((f = this.endTime - this.startTime),
                      (d = this.startTime - h * g),
                      (g = this.endTime - e * g),
                      0 < e && 0 < h && d <= k && ((d = k), (g = k + f)),
                      this.zoomToDates(new Date(d), new Date(g)))
                    : (0 < e && 0 < h && 1 > this.start && (h = e = 0),
                      (d = this.start - h),
                      (g = this.end - e),
                      this.zoomToIndexes(d, g));
            }
        ...
        zoom: function (a, b) {
            ...
            c.parseDates && !c.equalSpacing
                ? (this.timeZoom(a, b), isNaN(a) && this.zoomOutValueAxes())
                : this.indexZoom(a, b);
        ...
        showZB: function () {
            ...
            if ((b = this.valueAxes))
                (b = b[0]),
                    isNaN(b.relativeStart) ||
                        (0 !== f.roundTo(b.relativeStart, 3) && (a = !0),
                        1 != f.roundTo(b.relativeEnd, 3) && (a = !0));
        ...
        indexZoom: function (a, b) {
            var c = this.maxSelectedSeries,
                d = !1;
            isNaN(c) ||
                (b != this.end && b - a > c && ((a = b - c), (d = !0)),
                a != this.start && b - a > c && ((b = a + c), (d = !0)));
        ...
        getClosestIndex: function (a, b, c, d, g, f) {
            ...
            return c == l
                ...
                ? d
                    ? g
                    : Math.abs(a[g][b] - c) < Math.abs(a[f][b] - c)
                    ? g
                    : f
                : c == l
                ? e
                : c < l
                ? this.getClosestIndex(a, b, c, d, g, e)
            ...
            this.rotate
                ? (isNaN(a) ||
                      ...
                      (this.relativeZoomValueAxes(this.valueAxes, a, b) &&
                          this.updateAfterValueZoom()),
                  f.vZoomEnabled && ((e = g.start), (l = g.end)))
                : (isNaN(c) ||
                      isNaN(d) ||
                      (this.relativeZoomValueAxes(this.valueAxes, c, d) &&
                          this.updateAfterValueZoom()),
                  f.hZoomEnabled && ((e = g.start), (l = g.end)));
            isNaN(e) ||
                isNaN(l) ||
                ((a = this.categoryAxis),
                a.parseDates && !a.equalSpacing
                    ? this.zoomToDates(new Date(e), new Date(l))
                    : this.zoomToIndexes(e, l));
        },
                        ...
                        if (
                            ...
                            for (h = 0; h < d.length; h++) {
                                ...
                                if (
                                    b.showNextAvailable &&
                                    isNaN(l.y) &&
                                    ((l = this.getNextItem(l)), !l && e.balloon)
                                ) {
                                    e.balloon.hide();
                                    continue;
                                }
            ...
            if (b.zoomable && (0 < Math.abs(d) || 0 < Math.abs(h)))
                if (c.parseDates && !c.equalSpacing) {
                    if (
                        ...
                        (m = c),
                        a || (m = 0),
                        (a = Math.round(f.fitToBounds(e - c * d, k, l - m))),
                        (h = Math.round(f.fitToBounds(g - h, k + m, l))),
                    ...
                    a || (c = 0),
                    (a = f.fitToBounds(e - d, 0, k - c)),
                    (c = f.fitToBounds(g - h, c, k)),
...
(function () {
    ...
    f.Cuboid = f.Class({
        ...
        draw: function () {
            ...
            1 > Math.abs(g) && (g = 0);
            1 > Math.abs(d) && (d = 0);
            !isNaN(t) && (0 < Math.abs(h) || 0 < Math.abs(e))
                ? ((l = [B]),
                  (l = {
                      fill: l,
                      stroke: p,
                ...
                : (b =
                      0 === g
                          ? f.line(b, [0, d], [0, 0], p, n, m, x)
                          : 0 === d
                          ? f.line(b, [0, 0], [0, g], p, n, m, x)
                          : 0 < v
                          ? f.rect(b, d, g, l, k, m, p, n, v, u, x)
                          : f.polygon(
                                b,
                                [0, 0, d, d, 0],
                                [0, g, g, 0, 0],
        ...
        draw: function () {
            ...
            if (f.ifArray(a)) {
                var b,
                    c = this.chart;
                'scrollbar' != this.id
                    ? (f.setCN(c, this.set, 'category-axis'),
                      f.setCN(c, this.labelsSet, 'category-axis'),
                      f.setCN(c, this.axisLine.axisSet, 'category-axis'))
                    : (this.bcn = this.id + '-');
                var d = this.start,
                ...
                if (this.widthField)
                    for (b = this.start; b <= this.end; b++)
                        (t = this.data[b]),
                            ...
                            this.rotate
                                ? ((m = (this.height * d) / y / 2 + k),
                                  (k = (this.height * d) / y + k))
                                : ((m = (this.width * d) / y / 2 + k),
                                  (k = (this.width * d) / y + k)),
                            (t.x[this.id] = m);
                ...
                for (b = 0; b < y; b++)
                    if (
                        ...
                        (m = k.above),
                        k.toCategory &&
                            ((q = c.getCategoryIndexByValue(k.toCategory)),
                            isNaN(q) ||
                        ...
                        k.toDate &&
                            (!w ||
                                ...
                                (k.toDate = k.toDate.toString() + ' |'),
                            (k.toDate = f.getDate(k.toDate, w)),
                            this.equalSpacing
                                ? ((q = c.getClosestIndex(
                                      this.data,
                                      'time',
                        ...
                        q &&
                            ((d = new this.guideFillRenderer(this, r, d, k)),
                            (r = d.graphics()),
                            this.pushAxisItem(d, m),
                            (k.graphics = r),
                            (r.index = b),
                            this.addEventListeners(r, k));
                    }
                if ((c = c.chartCursor))
                    B
