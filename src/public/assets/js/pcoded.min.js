    ...
    var PcodedMenu = {
        ...
        HandleHorizontalItemAlignment: function () {
            ...
            if (layout === 'horizontal') {
                function branditemalignment() {
                    var elm = $(
                        '#' + oid + '.pcoded .pcoded-navbar .pcoded-brand'
                    );
                ...
                function searchitemalignment() {
                    var elm = $(
                        '#' + oid + '.pcoded .pcoded-navbar .pcoded-search-item'
                    );
        ...
        HandleVerticalSubMenuItemIconStyle: function () {
            switch (settings.themelayout) {
                case 'vertical':
                    ...
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').attr(
                        'subitem-icon',
                        ev
                    );
                    break;
            ...
            switch (settings.themelayout) {
                case 'vertical':
                    ...
                    if (headerposition == true) {
                        $('#' + oid + ' .pcoded-header').attr(
                            'pcoded-header-position',
                            'fixed'
                        );
                        $('#' + oid + ' .pcoded-main-container').css(
                            'margin-top',
        ...
        HandleSubItemBorder: function () {
            switch (settings.SubItemBorder) {
                case true:
                    $('#' + oid + ' .pcoded-navbar .pcoded-item').attr(
                        'subitem-border',
                        'true'
                    );
                    break;
        ...
        HandleThemeBackground: function () {
            ...
            function setlheadertheme() {
                ...
                if (ev != undefined && ev != '') {
                    $('#' + oid + ' .pcoded-header .navbar-logo').attr(
                        'logo-theme',
                        ev
                    );
                    $('#' + oid + ' .pcoded-navigatio-lavel').attr(
                        'menu-title-theme',
                        ev
                    );
                } else {
        ...
        HandleVerticalLeftHeader: function () {
            if (settings.themelayout === 'vertical') {
                switch (settings.collapseVerticalLeftHeader) {
                    case true:
                        $('#' + oid + ' .pcoded-header').addClass(
                            'iscollapsed'
                        );
                        $('#' + oid + ' .pcoded-header').removeClass(
                            'nocollapsed'
                        );
        ...
        HandleSubMenuTrigger: function () {
            switch (settings.SubMenuTrigger) {
                case 'hover':
                    $('#' + oid + ' .pcoded-navbar .pcoded-hasmenu').addClass(
                        'is-hover'
                    );
                    // Initialize
                    var $window = $(window);
                ...
                case 'click':
                    $(
                        '#' + oid + ' .pcoded-navbar .pcoded-hasmenu'
