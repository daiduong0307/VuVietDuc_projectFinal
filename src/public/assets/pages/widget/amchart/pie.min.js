    ...
    a.AmSlicedChart = a.Class({
        ...
        startSlice: function (f) {
            ...
            g &&
                ...
                g.animate({ opacity: 1, translate: '0,0' }, h, this.startEffect));
        },
        showLabels: function () {
        ...
        pullSlice: function (f, e, h) {
            ...
            if ((h = f.wedge)) {
                0 < g
                    ...
                    : (f.labelSet && f.labelSet.translate(e * f.pullX, e * f.pullY),
            ...
            if (void 0 !== i) {
                ...
                for (l = 0; l < j.length; l++) {
                    p
                        ...
                        : ((k = this.colors[l]), void 0 === k && (k = a.randomColor())),
        ...
        recalculatePercents: function () {
            ...
            for (h = 0; h < f.length; h++) {
                (g = this.chartData[h]),
                    (g.percents = !g.hidden && 0 < g.value ? (100 * g.value) / e : 0);
            }
        },
...
(function () {
    ...
    a.AmPieChart = a.Class({
            ...
            if (a.ifArray(Z)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    for (S = M = 0; S < Z.length; S++) {
                        (V = Z[S]),
                            !0 !== V.hidden && (M += a.roundTo(V.percents, this.pf.precision));
                    }
                    ...
                    for (var H, S = 0; S < Z.length; S++) {
                        if (
                            ((V = Z[S]),
                            !0 !== V.hidden && (this.showZeroSlices || 0 !== V.percents))
                        ) {
                            ...
                            if (
                                ...
                                var G = o;
                                isNaN(V.labelRadius) ||
                                    ((G = V.labelRadius), 0 > G && (V.skipTick = !0));
                                var K = O + M * (Q + G),
                                    I = L + J * (Q + G),
                                    k,
                                    s = 0;
                            ...
                            this.accessible &&
                                ...
                                ((I = this.formatString(this.accessibleLabel, V)),
        ...
        arrangeLabels: function () {
            ...
            for (g = e - 1; 0 <= g; g--) {
                (h = f[g]),
                    0 !== h.labelQuarter || h.hidden || this.checkOverlapping(g, h, 0, !0, 0);
            }
            for (g = 0; g < e; g++) {
                (h = f[g]),
                    1 != h.labelQuarter || h.hidden || this.checkOverlapping(g, h, 1, !1, 0);
            }
            for (g = e - 1; 0 <= g; g--) {
                (h = f[g]),
                    2 != h.labelQuarter || h.hidden || this.checkOverlapping(g, h, 2, !0, 0);
            }
            for (g = 0; g < e; g++) {
                (h = f[g]),
                    3 != h.labelQuarter || h.hidden || this.checkOverlapping(g, h, 3, !1, 0);
            }
        },
