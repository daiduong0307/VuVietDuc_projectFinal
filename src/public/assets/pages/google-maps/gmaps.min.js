...
!(function (a, b) {
    ...
    var a = function (a, b) {
        ...
        g = function (a, b) {
            var c,
                d = a.replace('.', '');
            return (c =
                'jQuery' in this && b ? $('.' + d, b)[0] : document.getElementsByClassName(d)[0]);
        },
        h = function (a, b) {
            var c,
                a = a.replace('#', '');
    ...
    (j.prototype.createControl = function (a) {
        ...
        (j.prototype.drawCircle = function (b) {
            (b = a({ map: this.map, center: new google.maps.LatLng(b.lat, b.lng) }, b)),
                delete b.lat,
                delete b.lng;
            for (
    ...
    return (
        ...
        (j.staticMapURL = function (a) {
            ...
            if ((delete a.polyline, a.center)) d.push('center=' + a.center), delete a.center;
                ...
                d.push(['center=', a.lat, ',', a.lng].join('')), delete a.lat, delete a.lng;
            else if (a.visible) {
        ...
        (j.on = function (a, b, c) {
            if (-1 == j.custom_events.indexOf(a))
                return b instanceof j && (b = b.map), google.maps.event.addListener(b, a, c);
        ...
        google.maps.Polygon.prototype.containsLatLng ||
            (google.maps.Polygon.prototype.containsLatLng = function (a) {
                ...
                for (var c = !1, d = this.getPaths().getLength(), e = 0; d > e; e++)
                    for (
                        var f = this.getPaths().getAt(e), g = f.getLength(), h = g - 1, i = 0;
                        g > i;
                        i++
                    ) {
                        var j = f.getAt(i),
                        ...
                        ((j.lng() < a.lng() && k.lng() >= a.lng()) ||
                            ...
                            j.lat() +
                                ((a.lng() - j.lng()) / (k.lng() - j.lng())) * (k.lat() - j.lat()) <
                                a.lat() &&
                            (c = !c),
                            (h = i);
                    }
        ...
        google.maps.Circle.prototype.containsLatLng ||
            (google.maps.Circle.prototype.containsLatLng = function (a) {
                return google.maps.geometry
                    ? google.maps.geometry.spherical.computeDistanceBetween(this.getCenter(), a) <=
                          this.getRadius()
                    : !0;
            }),
