        ...
        AmCharts.export = function (a, b) {
            var c,
                d = {
                    ...
                    drawing: {
                        ...
                        handler: {
                            undo: function (a, b) {
                                ...
                                if (c) {
                                    (c.selectable = !0),
                                        ...
                                        'added' == c.action && d.setup.fabric.remove(c.target);
                                    ...
                                    c.target.set(e),
                                        ...
                                        c.state != c.target.recentState ||
                                            b ||
                                            d.drawing.handler.undo(c, !0);
                                }
                            },
                            redo: function (a, b) {
                                ...
                                if (c) {
                                    (c.selectable = !0),
                                        ...
                                        'added' == c.action && d.setup.fabric.add(c.target);
                                    var e = JSON.parse(c.state);
                                    (c.target.recentState = c.state),
                                        ...
                                        d.setup.fabric.renderAll(),
                                        'addified' == c.action && d.drawing.handler.redo();
                                }
                            },
                            done: function (a) {
                                (d.drawing.enabled = !1),
                                    ...
                                    d.setup.wrapper &&
                                        (d.setup.chart.containerDiv.removeChild(d.setup.wrapper),
                                        (d.setup.wrapper = !1));
                            },
                            add: function (a) {
                                var b = d.deepMerge(
                                ...
                                c(b.url, function (a, c) {
                                    var e = void 0 !== c ? fabric.util.groupSVGElements(a, c) : a,
                                        f = !1;
                                    (e.height > d.setup.fabric.height ||
                                        e.width > d.setup.fabric.width) &&
                                        (f = d.setup.fabric.height / 2 / e.height),
                                        b.top > d.setup.fabric.height &&
                                            (b.top = d.setup.fabric.height / 2),
                                        b.left > d.setup.fabric.width &&
                                            (b.left = d.setup.fabric.width / 2),
                            ...
                            change: function (a, b, c) {
                                ...
                                if (
                                    (e.mode && (d.drawing.mode = e.mode),
                                    e.width &&
                                        ((d.drawing.width = e.width),
                                        (d.drawing.fontSize = e.fontSize = 3 * e.width),
                                        1 == d.drawing.width &&
                                            (d.drawing.fontSize = e.fontSize =
                                                d.defaults.fabric.drawing.fontSize)),
                                    e.fontSize && (d.drawing.fontSize = e.fontSize),
                                    e.color && (d.drawing.color = e.color),
                                    e.opacity && (d.drawing.opacity = e.opacity),
                                    (h = d.getRGBA(d.drawing.color)),
                                    h.pop(),
                                    h.push(d.drawing.opacity),
                                    (d.drawing.color = 'rgba(' + h.join() + ')'),
                                    (d.setup.fabric.freeDrawingBrush.color = d.drawing.color),
                                    (d.setup.fabric.freeDrawingBrush.width = d.drawing.width),
                                    i)
                                ) {
                                    for (
                                        f = JSON.parse(i.recentState).cfg,
                                            f &&
                                                ((e.color = e.color || f.color),
                                                (e.width = e.width || f.width),
                                                (e.opacity = e.opacity || f.opacity),
                                                (e.fontSize = e.fontSize || f.fontSize),
                                                (h = d.getRGBA(e.color)),
                                                h.pop(),
                                                h.push(e.opacity),
                                                (e.color = 'rgba(' + h.join() + ')')),
                                        ...
                                        j[g] instanceof fabric.Text ||
                                        j[g] instanceof fabric.PathGroup ||
                                        j[g] instanceof fabric.Triangle
                                            ? ((e.color || e.opacity) &&
                                                  j[g].set({ fill: e.color }),
                                              e.fontSize &&
                                                  j[g].set({
                                                      fontSize: e.fontSize,
                                                  }))
                                            : (j[g] instanceof fabric.Path ||
                                                  j[g] instanceof fabric.Line) &&
                                    ...
                                    b ||
                                        ((f = JSON.stringify(
                                            d.deepMerge(i.saveState().originalState, {
                                                cfg: {
                                                    color: e.color,
                                                    width: e.width,
                                                    opacity: e.opacity,
                            ...
                            text: function (a) {
                                ...
                                return (
                                    (d.drawing.buffer.isDrawing = !0),
                                    d.setup.fabric.add(c),
                                    d.setup.fabric.setActiveObject(c),
                                    c.selectAll(),
                                    c.enterEditing(),
                                    c
                                );
                            ...
                            line: function (a) {
                                var c,
                                    ...
                                    b = d.deepMerge(
                                        {
                                            x1:
                                                d.setup.fabric.width / 2 -
                                                d.setup.fabric.width / 10,
                                            x2:
                                                d.setup.fabric.width / 2 +
                                                d.setup.fabric.width / 10,
                                ...
                                if (
                                    ...
                                    b.arrow &&
                                        ((b.angle = b.angle
                                            ? b.angle
                                            : d.getAngle(b.x1, b.y1, b.x2, b.y2)),
                                        'start' == b.arrow
                                            ? ((f = b.y1 + b.width / 2), (g = b.x1 + b.width / 2))
                                            : 'middle' == b.arrow
                                            ? ((f = b.y2 + b.width / 2 - (b.y2 - b.y1) / 2),
                                              (g = b.x2 + b.width / 2 - (b.x2 - b.x1) / 2))
                                            : ((f = b.y2 + b.width / 2), (g = b.x2 + b.width / 2)),
                                        (e = new fabric.Triangle({
                                            top: f,
                                            left: g,
                                            fill: b.color,
                                            height: 7 * b.width,
                                    ...
                                    if (b.arrow) {
                                        ...
                                        return (
                                            ...
                                            'change' == b.action &&
                                                d.setup.fabric.setActiveObject(i),
                                            d.setup.fabric.add(i),
                                            i
                                        );
                                    }
                    ...
                    i18l: function (a, b) {
                        var c = b ? b : d.setup.chart.language ? d.setup.chart.language : 'en',
                            e =
                                AmCharts.translations[d.name][c] ||
                    ...
                    download: function (a, b, c) {
                        if (window.saveAs && d.setup.hasBlob) {
                            ...
                            (g.innerHTML = d.i18l('fallback.save.text')),
                                f.appendChild(g),
                                f.appendChild(h),
                                g.setAttribute('class', 'amcharts-export-fallback-message'),
                                f.setAttribute('class', 'amcharts-export-fallback'),
                                d.setup.chart.containerDiv.appendChild(f),
                                ...
                                d.createMenu([
                                    {
                                        ...
                                        click: function () {
                                            d.createMenu(d.config.menu),
                                                d.setup.chart.containerDiv.removeChild(f);
                                        },
                                    },
                                ]);
                        } else {
                            if (!d.config.fallback || 'image' != b.split('/')[0])
                                throw new Error(
                            ...
                            var f = document.createElement('div'),
                                g = document.createElement('div'),
                                i = d.toImage({ data: a });
                            (g.innerHTML = d.i18l('fallback.save.image')),
                                f.appendChild(g),
                                f.appendChild(i),
                                g.setAttribute('class', 'amcharts-export-fallback-message'),
                                f.setAttribute('class', 'amcharts-export-fallback'),
                    ...
                    loadResource: function (a, b) {
                        var c,
                            ...
                            h,
                            i,
                            j = a.indexOf('//') != -1 ? a : [d.libs.path, a].join(''),
                            k = function () {
                        ...
                        for (
                            a.indexOf('.js') != -1
                                ? ((f = document.createElement('script')),
                                  ...
                                  d.libs.async && f.setAttribute('async', ''))
                                : a.indexOf('.css') != -1 &&
                                ...
                                c = 0;
                            c < document.head.childNodes.length;
                            c++
                        )
                            if (
                                ((g = document.head.childNodes[c]),
                                (h = !!g && (g.src || g.href)),
                                (i = !!g && g.tagName),
                                g && h && h.indexOf(a) != -1)
                            ) {
                        ...
                        (e && !d.libs.reload) ||
                            ...
                            d.listenersToRemove || (d.listenersToRemove = []),
                        ...
                        if (d.libs.autoLoad)
                            for (a = 0; a < d.libs.resources.length; a++)
                                if (d.libs.resources[a] instanceof Object)
                                    for (b in d.libs.resources[a])
                                        d.loadResource(b, d.libs.resources[a][b]);
                    ...
                    cloneObject: function (a) {
                        ...
                        for (e in a)
                            (c = a[e]),
                                (f = 'object' == typeof c),
                                (g = c instanceof Date),
                                (b[e] = f && !g ? d.cloneObject(c) : c);
                        return b;
                    },
                    deepMerge: function (a, b, c) {
                        var e,
                            f,
                            g = b instanceof Array ? 'array' : 'object';
                            ...
                            ('array' == g && isNaN(e)) ||
                                ...
                                ((a && void 0 == a[e]) || c) &&
                                    (f instanceof Array
                                        ...
                                        : f instanceof Number
                                        ? (a[e] = new Number())
                                        : f instanceof String && (a[e] = new String())),
                                (f instanceof Object || f instanceof Array) &&
                                !(f instanceof Function || f instanceof Date || d.isElement(f)) &&
                                'chart' != e &&
                                'scope' != e
                                    ? d.deepMerge(a[e], f, c)
                                    : a instanceof Array && !c
                                    ? a.push(f)
                                    : a && (a[e] = f));
                        return a;
                    },
                    ...
                    isTainted: function (a) {
                        ...
                        if (a) {
                            if (
                                ...
                                return !0;
                            if (a.indexOf('//') != -1 && a.indexOf(b.replace(/.*:/, '')) == -1)
                                return !0;
                        }
                        return !1;
                    },
                            ...
                            (g =
                                0 == e
                                    ...
                                    ? e > 0
                                        ...
                                        : Math.PI
                                    : e < 0
                                    ? Math.atan(f / e) + Math.PI
                                    : f < 0
                                    ? Math.atan(f / e) + 2 * Math.PI
                                    : Math.atan(f / e)),
                            (180 * g) / Math.PI
                        );
                    },
                    gatherAttribute: function (a, b, c, e) {
                        var f,
                            e = e ? e : 0,
                            c = c ? c : 3;
                        return a && ((f = a.getAttribute(b)), !f && e < c)
                            ? d.gatherAttribute(a.parentNode, b, c, e + 1)
                            : f;
                    },
                    gatherClassName: function (a, b, c, e) {
                        ...
                        if (d.isElement(a)) {
                            if (
                                ((f = (a.getAttribute('class') || '').split(' ').indexOf(b) != -1),
                                !f && e < c)
                            )
                                return d.gatherClassName(a.parentNode, b, c, e + 1);
                            f && (f = a);
                        }
                        return f;
                    },
                    gatherElements: function (a, b, c) {
                        ...
                        for (e = 0; e < a.children.length; e++) {
                            ...
                            if ('clipPath' == g.tagName) {
                                var h = {},
                                    i = fabric.parseTransformAttribute(
                                        d.gatherAttribute(g, 'transform'),
                                    );
                                for (f = 0; f < g.childNodes.length; f++)
                                    g.childNodes[f].setAttribute('fill', 'transparent'),
                                        (h = {
                                            x: d.pxToNumber(g.childNodes[f].getAttribute('x')),
                                            y: d.pxToNumber(g.childNodes[f].getAttribute('y')),
                                            width: d.pxToNumber(
                                                g.childNodes[f].getAttribute('width'),
                                            ),
                                            height: d.pxToNumber(
                                                g.childNodes[f].getAttribute('height'),
                                            ),
                                        });
                                a.clippings[g.id] = {
                                    svg: g,
                                ...
                                for (f = 0; f < g.childNodes.length; f++)
                                    if ('rect' == g.childNodes[f].tagName)
                                        j.fill = g.childNodes[f].getAttribute('fill');
                                    else if ('image' == g.childNodes[f].tagName) {
                                        var k = fabric.parseAttributes(
                                            g.childNodes[f],
                                            fabric.SHARED_ATTRIBUTES,
                                        );
                                        k.transformMatrix &&
                                            ((j.offsetX = k.transformMatrix[4]),
                                            (j.offsetY = k.transformMatrix[5]));
                                    }
                                d.removeImage(j.source)
                                    ? (a.patterns[g.id] = j.fill ? j.fill : 'transparent')
                                    : (a.patterns[j.node.id] = j);
                            } else if ('image' == g.tagName)
                                c.included++,
                                    fabric.Image.fromURL(
                                ...
                                for (f = 0; f < k.length; f++) {
                                    ...
                                    !m ||
                                        n ||
                                        o ||
                                        (g.setAttribute(l, 'none'),
                                        g.setAttribute(l + '-opacity', '0'));
                                }
                            }
                        }
                        return a;
                    ...
                    getRGBA: function (a, b) {
                        return (
                            !(
                                ...
                                'transparent' == a ||
                                d.isHashbanged(a) ||
                                ((a = new fabric.Color(a)), !a._source)
                            ) && (b ? a : a.getSource())
                        );
                    },
                    gatherPosition: function (a, b) {
                        var f,
                            c = d.drawing.buffer.position,
                            e = fabric.util.invertTransform(d.setup.fabric.viewportTransform);
                        return (
                            'touchmove' == a.type &&
                                ('touches' in a
                                    ? (a = a.touches[0])
                                    : 'changedTouches' in a && (a = a.changedTouches[0])),
                            (f = fabric.util.transformPoint(d.setup.fabric.getPointer(a, !0), e)),
                            1 == b && ((c.x1 = f.x), (c.y1 = f.y)),
                            (c.x2 = f.x),
                            (c.y2 = f.y),
                            (c.xD = c.x1 - c.x2 < 0 ? (c.x1 - c.x2) * -1 : c.x1 - c.x2),
                            (c.yD = c.y1 - c.y2 < 0 ? (c.y1 - c.y2) * -1 : c.y1 - c.y2),
                            c
                        );
                    },
                        ...
                        (fabric.ElementsParser.prototype.resolveGradient = function (a, b) {
                            ...
                            if (/^url\(/.test(c)) {
                                ...
                                if (fabric.gradientDefs[this.svgUid][e]) {
                                    var f = fabric.Gradient.fromElement(
                                        fabric.gradientDefs[this.svgUid][e],
                                        a,
                                    );
                                    f.coords.y1 &&
                                        'pie' != d.setup.chart.type &&
                                        ((f.coords.y2 = f.coords.y1 * -1), (f.coords.y1 = 0)),
                                        a.set(b, f);
                                }
                            }
                        }),
                            (fabric.Text.fromElement = function (a, b) {
                                ...
                                (b = fabric.util.object.extend(
                                    b ? fabric.util.object.clone(b) : {},
                                    c,
                                )),
                                    (b.top = b.top || 0),
                                    (b.left = b.left || 0),
                                    ...
                                    'dy' in c && (b.top += c.dy),
                                    'fontSize' in b ||
                                        (b.fontSize = fabric.Text.DEFAULT_SVG_FONT_SIZE),
                                ...
                                if ('textContent' in a)
                                    if (a.childNodes)
                                        for (var f = 0; f < a.childNodes.length; f++)
                                            e.push(a.childNodes[f].textContent);
                                    else e.push(a.textContent);
                                else
                                    'firstChild' in a &&
                                        null !== a.firstChild &&
                                        'data' in a.firstChild &&
                                        null !== a.firstChild.data &&
                                        e.push(a.firstChild.data);
                                d = e.join('\n');
                                var g = new fabric.Text(d, b),
                                    h = 0;
                                return (
                                    'left' === g.originX && (h = g.getWidth() / 2),
                                    'right' === g.originX && (h = -g.getWidth() / 2),
                                    e.length > 1
                                        ? g.set({
                                              left: g.getLeft() + h,
                                              top:
                                                  ...
                                                  g.fontSize *
                                                      (e.length - 1) *
                                                      (0.18 + g._fontSizeFraction),
                                              textAlign: b.originX,
                                              lineHeight: e.length > 1 ? 0.965 : 1.16,
                                          })
                                        : g.set({
                                              left: g.getLeft() + h,
                                              top:
                                                  g.getTop() -
                                                  g.getHeight() / 2 +
                                                  g.fontSize * (0.18 + g._fontSizeFraction),
                                          }),
                                    g
                                );
                            });
                    ...
                    capture: function (a, b) {
                        var c,
                            e = d.deepMerge(d.deepMerge({}, d.config.fabric), a || {}),
                            f = [],
                            g = {
                                x: 0,
                                y: 0,
                        ...
                        for (c = 0; c < j.length; c++) {
                            ...
                            (k.has.legend = d.gatherClassName(
                                k.parent,
                                d.setup.chart.classNamePrefix + '-legend-div',
                                1,
                            )),
                                (k.has.panel = d.gatherClassName(
                                    k.parent,
                                    d.setup.chart.classNamePrefix + '-stock-panel-div',
                                )),
                                (k.has.scrollbar = d.gatherClassName(
                                    k.parent,
                                    d.setup.chart.classNamePrefix + '-scrollbar-chart-div',
                                )),
                                (k = d.gatherElements(k, e, h)),
                                f.push(k);
                        }
                        if (d.config.legend) {
                            if ('stock' == d.setup.chart.type)
                                for (c = 0; c < d.setup.chart.panels.length; c++)
                                    d.setup.chart.panels[c].stockLegend &&
                                        d.setup.chart.panels[c].stockLegend.divId &&
                                        i.items.push(d.setup.chart.panels[c].stockLegend);
                            else
                                d.setup.chart.legend &&
                                    d.setup.chart.legend.divId &&
                                    i.items.push(d.setup.chart.legend);
                            for (c = 0; c < i.items.length; c++) {
                                var l = i.items[c],
                                    k = {
                                        ...
                                        legend: {
                                            id: c,
                                            type:
                                                ['top', 'left'].indexOf(d.config.legend.position) !=
                                                -1
                                                    ? 'unshift'
                                                    : 'push',
                                            ...
                                            width: d.config.legend.width
                                                ...
                                                : l.container.div.offsetWidth,
                                            height: d.config.legend.height
                                                ? d.config.legend.height
                                                : l.container.div.offsetHeight,
                                        },
                                        patterns: {},
                                        clippings: {},
                                        has: {
                                ...
                                (i.width += k.legend.width),
                                    (i.height += k.legend.height),
                                    (i.maxWidth =
                                        k.legend.width > i.maxWidth ? k.legend.width : i.maxWidth),
                                    (i.maxHeight =
                                        k.legend.height > i.maxHeight
                                            ? k.legend.height
                                            : i.maxHeight),
                                    (k = d.gatherElements(k, e, h)),
                                    f[k.legend.type](k);
                            }
                            ['top', 'bottom'].indexOf(d.config.legend.position) != -1
                                ? ((g.width = i.maxWidth > g.width ? i.maxWidth : g.width),
                                  (g.height += i.height))
                                : ['left', 'right'].indexOf(d.config.legend.position) != -1
                                ? ((g.width += i.maxWidth),
                                  (g.height = i.height > g.height ? i.height : g.height))
                                : ((g.height += i.height), (g.width += i.maxWidth));
                        }
                        if (
                            ((d.drawing.enabled = e.drawing.enabled = 'draw' == e.action),
                            ...
                            d.setup.chart.leftContainer &&
                                ...
                                d.setup.chart.periodSelector &&
                                    ...
                                    (m[d.setup.chart.periodSelector.position] +=
                                        d.setup.chart.periodSelector.offsetHeight +
                                        d.setup.chart.panelsSettings.panelSpacing)),
                                d.setup.chart.dataSetSelector &&
                                    ...
                                    ((g.height -= d.setup.chart.dataSetSelector.offsetHeight),
                                    (m[d.setup.chart.dataSetSelector.position] +=
                                        d.setup.chart.dataSetSelector.offsetHeight)),
                                (d.setup.wrapper.style.paddingTop = d.numberToPx(m.top)),
                                (d.setup.wrapper.style.paddingRight = d.numberToPx(m.right)),
                                (d.setup.wrapper.style.paddingBottom = d.numberToPx(m.bottom)),
                                (d.setup.wrapper.style.paddingLeft = d.numberToPx(m.left));
                        }
                        for (
                            d.setup.canvas = document.createElement('canvas'),
                                d.setup.wrapper.appendChild(d.setup.canvas),
                                d.setup.fabric = new fabric.Canvas(
                                    d.setup.canvas,
                                    d.deepMerge(
                                        {
                                            width: g.width,
                                ...
                                d.deepMerge(d.setup.fabric, e),
                                d.deepMerge(d.setup.fabric.freeDrawingBrush, e.drawing),
                                d.deepMerge(d.drawing, e.drawing),
                                d.drawing.handler.change(e.drawing),
                                d.setup.fabric.on('mouse:down', function (a) {
                                    d.gatherPosition(a.e, 1);
                                    (d.drawing.buffer.pressedTS = Number(new Date())),
                                        d.isPressed(a.e),
                                    ...
                                    if (
                                        ...
                                        d.drawing.buffer.isPressed &&
                                            ...
                                            !d.drawing.buffer.line &&
                                                ...
                                                d.setup.fabric.remove(
                                                    d.setup.fabric._objects.pop(),
                                                ),
                                                (d.drawing.buffer.line = d.drawing.handler.line({
                                                    ...
                                                    y2: b.y2,
                                                    arrow:
                                                        'line' != d.drawing.mode && d.drawing.arrow,
                                                    action: 'config',
                                                })))),
                                        d.drawing.buffer.isSelected &&
                                            (d.setup.fabric.isDrawingMode = !1),
                                        ...
                                        var e,
                                            f,
                                            g,
                                            h = d.drawing.buffer.line;
                                        for (
                                            h.x2 = b.x2, h.y2 = b.y2, c = 0;
                                            c < h.group.length;
                                            c++
                                        )
                                            (e = h.group[c]),
                                                e instanceof fabric.Line
                                                    ? e.set({
                                                          x2: h.x2,
                                                          y2: h.y2,
                                                      })
                                                    : e instanceof fabric.Triangle &&
                                                      ((h.angle =
                                                          d.getAngle(h.x1, h.y1, h.x2, h.y2) + 90),
                                                      'start' == h.arrow
                                                          ? ((f = h.y1 + h.width / 2),
                                                            (g = h.x1 + h.width / 2))
                                                          : 'middle' == h.arrow
                                ...
                                d.setup.fabric.on('mouse:up', function (a) {
                                    ...
                                    if (d.drawing.buffer.line) {
                                        for (c = 0; c < d.drawing.buffer.line.group.length; c++)
                                            d.drawing.buffer.line.group[c].remove();
                                ...
                                d.setup.fabric.on('object:selected', function (a) {
                                    (d.drawing.buffer.isSelected = !0),
                                        (d.drawing.buffer.target = a.target),
                                        (d.setup.fabric.isDrawingMode = !1);
                                }),
                                ...
                                d.setup.fabric.on('path:created', function (a) {
                                    ...
                                    if (!d.drawing.buffer.isDrawing || d.drawing.buffer.hasLine)
                                        return (
                                            d.setup.fabric.remove(b),
                                            void d.setup.fabric.renderAll()
                                        );
                                }),
                                ...
                                d.drawing.enabled
                                    ? (d.setup.wrapper.setAttribute(
                                      ...
                                      (d.setup.wrapper.style.backgroundColor = e.backgroundColor),
                            ...
                            var k = f[c];
                            'stock' == d.setup.chart.type && d.setup.chart.legendSettings.position
                                ? ['top', 'bottom'].indexOf(
                                      d.setup.chart.legendSettings.position,
                                  ) != -1
                                    ? k.parent.style.top && k.parent.style.left
                                        ? ((k.offset.y = d.pxToNumber(k.parent.style.top)),
                                          (k.offset.x = d.pxToNumber(k.parent.style.left)))
                                        : ((k.offset.x = g.x),
                                          (k.offset.y = g.y),
                                          (g.y += d.pxToNumber(k.parent.style.height)),
                                          k.has.panel
                                              ? ((g.pY = d.pxToNumber(k.has.panel.style.marginTop)),
                                                (k.offset.y += g.pY))
                                              : k.has.scrollbar && (k.offset.y += g.pY))
                                    : ['left', 'right'].indexOf(
                                          d.setup.chart.legendSettings.position,
                                      ) != -1 &&
                                      ((k.offset.y = d.pxToNumber(k.parent.style.top) + g.pY),
                                      (k.offset.x = d.pxToNumber(k.parent.style.left) + g.pX),
                                      k.has.legend
                                          ? (g.pY +=
                                                d.pxToNumber(k.has.panel.style.height) +
                                                d.setup.chart.panelsSettings.panelSpacing)
                                          : k.has.scrollbar &&
                                            (k.offset.y -=
                                                d.setup.chart.panelsSettings.panelSpacing))
                                : ('absolute' == k.parent.style.position
                                      ? ((k.offset.absolute = !0),
                                        (k.offset.top = d.pxToNumber(k.parent.style.top)),
                                        (k.offset.right = d.pxToNumber(k.parent.style.right, !0)),
                                        (k.offset.bottom = d.pxToNumber(k.parent.style.bottom, !0)),
                                        (k.offset.left = d.pxToNumber(k.parent.style.left)),
                                        (k.offset.width = d.pxToNumber(k.parent.style.width)),
                                        (k.offset.height = d.pxToNumber(k.parent.style.height)))
                                      : k.parent.style.top && k.parent.style.left
                                      ? ((k.offset.y = d.pxToNumber(k.parent.style.top)),
                                        (k.offset.x = d.pxToNumber(k.parent.style.left)))
                                      : k.legend
                                      ? ('left' == k.legend.position
                                            ? (g.x = i.maxWidth)
                                            : 'right' == k.legend.position
                                            ? (k.offset.x = g.width - i.maxWidth)
                                            : 'top' == k.legend.position
                                            ? (g.y += k.legend.height)
                                            : 'bottom' == k.legend.position &&
                                              (k.offset.y = g.height - i.height),
                                        (k.offset.y += g.lY),
                                        (g.lY += k.legend.height))
                                      : ((k.offset.x = g.x),
                                        (k.offset.y = g.y + g.pY),
                                        (g.y += d.pxToNumber(k.parent.style.height))),
                                  k.has.legend && k.has.panel && k.has.panel.style.marginTop
                                      ? ((g.y += d.pxToNumber(k.has.panel.style.marginTop)),
                                        (k.offset.y += d.pxToNumber(k.has.panel.style.marginTop)))
                                      : d.setup.chart.legend &&
                                        ['left', 'right'].indexOf(d.setup.chart.legend.position) !=
                                            -1 &&
                                        ((k.offset.y = d.pxToNumber(k.parent.style.top)),
                                        (k.offset.x = d.pxToNumber(k.parent.style.left)))),
                                fabric.parseSVGDocument(
                                    ...
                                    (function (a) {
                                        return function (c, i) {
                                            var j,
                                                l = fabric.util.groupSVGElements(c, i),
                                                m = [],
                                                n = {
                                                    selectable: !1,
                                                    isCoreElement: !0,
                                            ...
                                            for (
                                                a.offset.absolute
                                                    ? (void 0 !== a.offset.bottom
                                                          ? (n.top =
                                                                g.height -
                                                                a.offset.height -
                                                                a.offset.bottom)
                                                          : (n.top = a.offset.top),
                                                      void 0 !== a.offset.right
                                                          ? (n.left =
                                                                g.width -
                                                                a.offset.width -
                                                                a.offset.right)
                                                          : (n.left = a.offset.left))
                                                    : ((n.top = a.offset.y), (n.left = a.offset.x)),
                                                    j = 0;
                                                j < l.paths.length;
                                                j++
                                            ) {
                                                var o = null;
                                                if (l.paths[j]) {
                                                    if (d.removeImage(l.paths[j]['xlink:href']))
                                                        continue;
                                                    if (l.paths[j].fill instanceof Object)
                                                        'radial' == l.paths[j].fill.type &&
                                                            ['pie', 'gauge'].indexOf(
                                                                d.setup.chart.type,
                                                            ) == -1 &&
                                                            ((l.paths[j].fill.coords.r2 =
                                                                l.paths[j].fill.coords.r1 * -1),
                                                            (l.paths[j].fill.coords.r1 = 0),
                                                            l.paths[j].set({
                                                                opacity: l.paths[j].fillOpacity,
                                                            }));
                                                    else if (
                                                        (o = d.isHashbanged(l.paths[j].fill)) &&
                                                        a.patterns &&
                                                        a.patterns[o]
                                                    ) {
                                                        var p = a.patterns[o];
                                                    ...
                                                    (o = d.isHashbanged(l.paths[j].clipPath)) &&
                                                        a.clippings &&
                                                        a.clippings[o] &&
                                                        (!(function (b, c) {
                                            ...
                                            if (
                                                ...
                                                (n.left += 0.5),
                                                l.set(n),
                                                d.setup.fabric.add(l),
                                                a.svg.parentNode &&
                                                    a.svg.parentNode.getElementsByTagName)
                                            ) {
                                                var q = a.svg.parentNode.getElementsByClassName(
                                                    d.setup.chart.classNamePrefix + '-balloon-div',
                                                );
                                                for (j = 0; j < q.length; j++)
                                                    if (e.balloonFunction instanceof Function)
                                                        e.balloonFunction.apply(d, [q[j], a]);
                                                    else {
                                                        var r = q[j],
                                                            s = fabric.parseStyleAttribute(r),
                                                            t = fabric.parseStyleAttribute(
                                                                r.childNodes[0],
                                                            ),
                                                            u = new fabric.Text(
                                                                r.innerText ||
                                            ...
                                            if (
                                                a.svg.nextSibling &&
                                                'A' == a.svg.nextSibling.tagName
                                            ) {
                                                var r = a.svg.nextSibling,
                                                    s = fabric.parseStyleAttribute(r),
                                                    u = new fabric.Text(
                                                        r.innerText || r.textContent || r.innerHTML,
                                                        {
                                                            selectable: !1,
                                                            top: s.top + a.offset.y,
                                                            left: s.left + a.offset.x,
                                            ...
                                            if ((f.pop(), !f.length))
                                                var v = Number(new Date()),
                                                    w = setInterval(function () {
                                                        var a = Number(new Date());
                                                        (h.loaded == h.included ||
                                                            a - v > d.config.fabric.loadTimeout) &&
                                                            (clearTimeout(w),
                                                            d.handleBorder(e),
                                                            d.handleCallback(e.afterCapture, e),
                                                            d.setup.fabric.renderAll(),
                                                            d.handleCallback(b, e));
                                                    }, AmCharts.updateRate);
                                        };
                                    })(k),
                                    function (a, b) {
                                        var c,
                                            f = d.gatherAttribute(a, 'class'),
                                            g = d.gatherAttribute(a, 'visibility'),
                                            h = d.gatherAttribute(a, 'clip-path');
                                        (b.className = String(f)),
                                            (b.classList = String(f).split(' ')),
                                            (b.clipPath = h),
                                            (b.svg = a);
                                        var i = ['fill', 'stroke'];
                                        for (c = 0; c < i.length; c++) {
                                            var j = i[c],
                                                ...
                                                m = d.getRGBA(k);
                                            'hidden' == g && ((b.opacity = 0), (l = 0)),
                                                m &&
                                                    (m.pop(),
                                                    m.push(l),
                                                    (b[j] = 'rgba(' + m.join() + ')'),
                                                    (b[j + d.capitalize('opacity')] = l));
                                        }
                    ...
                    toImage: function (a, b) {
                        ...
                        return (
                            ...
                            (c.data ||
                                (e =
                                    c.lossless || 'svg' == c.format
                                        ? d.toSVG(d.deepMerge(c, { getBase64: !0 }))
                                        : d.setup.fabric.toDataURL(c)),
                            f.setAttribute('src', e),
                            d.handleCallback(b, f, c),
                            f)
                        );
                    },
                    toBlob: function (a, b) {
                        var e,
                            c = d.deepMerge({ data: 'empty', type: 'text/plain' }, a || {}),
                            f = /^data:.+;base64,(.*)$/.exec(c.data);
                        return (
                            f &&
                                ((c.data = f[0]),
                                (c.type = c.data.slice(5, c.data.indexOf(',') - 7)),
                                (c.data = d.toByteArray({
                                    data: c.data.slice(c.data.indexOf(',') + 1, c.data.length),
                                }))),
                            (e = c.getByteArray ? c.data : new Blob([c.data], { type: c.type })),
                            d.handleCallback(b, e, c),
                            e
                        );
                    },
                    toJPG: function (a, b) {
                    ...
                    toSVG: function (a, b) {
                            ...
                            f = d.deepMerge(
                                {
                                    ...
                                    reviver: function (a, b) {
                                        var f = new RegExp(/\bstyle=(['"])(.*?)\1/),
                                            g = f.exec(a)[0].slice(7, -1),
                                            h = g.split(';'),
                                            i = [];
                                        for (i1 = 0; i1 < h.length; i1++)
                                            if (h[i1]) {
                                                var j = h[i1].replace(/\s/g, '').split(':'),
                                                    k = j[0],
                                                    l = j[1];
                                                if (['fill', 'stroke'].indexOf(k) != -1)
                                                    if ((l = d.getRGBA(l, !0))) {
                                                        var m = '#' + l.toHex(),
                                                            n = l._source[3];
                                                        i.push([k, m].join(':')),
                                                            i.push([k + '-opacity', n].join(':'));
                                                    } else i.push(h[i1]);
                                                else 'opactiy' != k && i.push(h[i1]);
                                            }
                                        if (((a = a.replace(g, i.join(';'))), b && b.svg)) {
                                            ...
                                            '/>' != q && ((p = 3), (q = a.slice(-p)));
                                            var s =
                                                (a.slice(0, a.length - p),
                                                ' clip-path="url(#' + b.svg.id + ')" ');
                                            if (
                                                ((a = '<g ' + s + '>' + a + '</g>'),
                                                e.indexOf(o) == -1)
                                            ) {
                        ...
                        if (((g = d.setup.fabric.toSVG(f, f.reviver)), c.length)) {
                            var h = g.slice(0, g.length - 6),
                                i = g.slice(-6);
                            g = h + c.join('') + i;
                        }
                        return (
                            f.compress && (g = g.replace(/[\t\r\n]+/g, '')),
                            f.getBase64 && (g = 'data:image/svg+xml;base64,' + btoa(g)),
                            d.handleCallback(b, g, f),
                            g
                        );
                    },
                    toPDF: function (a, b) {
                        ...
                        function g(a, b) {
                            ...
                            if (!c)
                                throw new Error('The given pageSize "' + a + '" does not exist!');
                        ...
                        if (
                            ...
                            (i[0] -= j.left + j.right),
                                (i[1] -= j.top + j.bottom),
                                c.pageOrigin &&
                                    (h.push(d.i18l('label.saved.from')),
                                    h.push(window.location.href),
                                    (i[1] -= 28.128)),
                                h.push({ image: 'reference', fit: i }),
                                (c.content = h);
                        }
                        return (
                            b &&
                    ...
                    toPRINT: function (a, b) {
                        var c,
                            e = d.deepMerge({ delay: 0.01, lossless: !1 }, a || {}),
                            f = d.toImage(e),
                            g = [],
                            h = document.body.childNodes,
                            i = document.documentElement.scrollTop || document.body.scrollTop;
                        for (
                            f.setAttribute('style', 'width: 100%; max-height: 100%;'), c = 0;
                            c < h.length;
                            c++
                        )
                            d.isElement(h[c]) &&
                                ((g[c] = h[c].style.display), (h[c].style.display = 'none'));
                        return (
                            document.body.appendChild(f),
                            setTimeout(function () {
                                window.print(), (e.delay *= 1e3);
                                var a =
                                    /iPad|iPhone|iPod/.test(navigator.userAgent) &&
                                    !window.MSStream;
                                a && e.delay < 1e3 && (e.delay = 1e3),
                                    setTimeout(function () {
                                        for (c = 0; c < h.length; c++)
                                            d.isElement(h[c]) && (h[c].style.display = g[c]);
                                        document.body.removeChild(f),
                                            (document.documentElement.scrollTop =
                                                document.body.scrollTop =
                                                    i),
                                            d.handleCallback(b, f, e);
                                    }, e.delay);
                            }, 1),
                            f
                        );
                    ...
                    toJSON: function (a, b) {
                        ...
                        return (
                            ...
                            ((c.data = void 0 !== c.data ? c.data : d.getChartData(c)),
                            (e = JSON.stringify(c.data, void 0, '\t')),
                            d.handleCallback(b, e, c),
                            e)
                        );
                    },
                                ...
                                for (var f = 0; f != a[e].length; ++f) {
                                    ...
                                    if (null != g.v) {
                                        ...
                                        'number' == typeof g.v
                                            ...
                                            : g.v instanceof Date
                                            ? ((g.t = 'n'),
                                              (g.z = XLSX.SSF._table[14]),
                                              (g.v = h(g.v)))
                                            : g.v instanceof Object
                                            ? ((g.t = 's'), (g.v = JSON.stringify(g.v)))
                                            : (g.t = 's'),
                                            (c[i] = g);
                                    }
                                }
                    ...
                    toArray: function (a, b) {
                        ...
                        if (
                            ((f.processData = k),
                            (f.data = void 0 !== f.data ? d.processData(f) : d.getChartData(f)),
                            f.withHeader)
                        ) {
                            i = [];
                            ...
                            if (((i = []), !isNaN(c))) {
                                for (e in h)
                                    if (!isNaN(e)) {
                                        var e = h[e],
                                            m = f.data[c][e];
                                        (m = null == m ? '' : f.stringify ? String(m) : m),
                                            i.push(l(m));
                                    }
                                g.push(i);
                            }
                    ...
                    toByteArray: function (a, b) {
                        ...
                        function m(a) {
                            ...
                            var i = a.length;
                            (g = '=' === a.charAt(i - 2) ? 2 : '=' === a.charAt(i - 1) ? 1 : 0),
                                (h = new e((3 * a.length) / 4 - g)),
                                (d = g > 0 ? a.length - 4 : a.length);
                            var j = 0;
                            for (b = 0, c = 0; b < d; b += 4, c += 3)
                                (f =
                                    (l(a.charAt(b)) << 18) |
                                    (l(a.charAt(b + 1)) << 12) |
                                    (l(a.charAt(b + 2)) << 6) |
                            ...
                            return (
                                2 === g
                                    ? ((f = (l(a.charAt(b)) << 2) | (l(a.charAt(b + 1)) >> 4)),
                                      k(255 & f))
                                    : 1 === g &&
                                      ((f =
                                          (l(a.charAt(b)) << 10) |
                    ...
                    handleNamespace: function (a, b) {
                        function h() {
                            ...
                            (e = !!(a in c)),
                                'pdfMake' == a && e && (e = c.pdfMake.vfs),
                                e
                                    ? (clearTimeout(g),
                                      b.cb.apply(b.scope, b.args),
                                      d.handleLog(
                                          [
                    ...
                    handleBorder: function (a) {
                        if (d.config.border instanceof Object) {
                            var b = d.deepMerge(d.defaults.fabric.border, a.border || {}, !0),
                                c = new fabric.Rect();
                            (b.width = d.setup.fabric.width - b.strokeWidth),
                                (b.height = d.setup.fabric.height - b.strokeWidth),
                                c.set(b),
                                d.setup.fabric.add(c);
                        }
                    },
                    handleDropbox: function (a) {
                        if (d.drawing.enabled)
                            if ((a.preventDefault(), a.stopPropagation(), 'dragover' == a.type))
                                d.setup.wrapper.setAttribute(
                                    'class',
                                    d.setup.chart.classNamePrefix + '-export-canvas active dropbox',
                                );
                            else if (
                                (d.setup.wrapper.setAttribute(
                                    'class',
                                ...
                                'drop' == a.type && a.dataTransfer.files.length)
                            )
                                for (var b = 0; b < a.dataTransfer.files.length; b++) {
                                    ...
                                    (c.onloadend = (function (b) {
                                        ...
                                        c.readAsDataURL(a.dataTransfer.files[b]);
                                }
                    },
                        ...
                        for (filename in d.libs.namespaces) {
                            ...
                            !(function (b) {
                                var c = setInterval(function () {
                                    ...
                                    (f - e > d.libs.loadTimeout || b in window) &&
                                        (clearTimeout(c),
                                        d.handleCallback(a, b, f - e > d.libs.loadTimeout));
                                }, AmCharts.updateRate);
                            })(f);
                        }
                    },
                    getChartData: function (a) {
                        ...
                        if (0 == b.data.length)
                            if ('stock' == d.setup.chart.type) {
                                for (
                                    b.data = d.cloneObject(d.setup.chart.mainDataSet.dataProvider),
                                        j(d.setup.chart.mainDataSet.categoryField),
                                        b.dateFields.push(d.setup.chart.mainDataSet.categoryField),
                                        e = 0;
                                    e < d.setup.chart.mainDataSet.fieldMappings.length;
                                    e++
                                ) {
                                    ...
                                    for (f = 0; f < d.setup.chart.panels.length; f++) {
                                        ...
                                        for (g = 0; g < l.stockGraphs.length; g++) {
                                            ...
                                            for (i4 = 0; i4 < h.length; i4++)
                                                m[h[i4]] == k.toField &&
                                                    j(k.fromField, m.title, h[i4]);
                                        }
                                    }
                                }
                                if (d.setup.chart.comparedGraphs.length) {
                                    for (i = [], e = 0; e < b.data.length; e++)
                                        i.push(b.data[e][d.setup.chart.mainDataSet.categoryField]);
                                    for (e = 0; e < d.setup.chart.comparedGraphs.length; e++) {
                                        ...
                                        for (f = 0; f < m.dataSet.dataProvider.length; f++) {
                                            ...
                                            if (p != -1)
                                                for (
                                                    g = 0;
                                                    g < m.dataSet.fieldMappings.length;
                                                    g++
                                                ) {
                                                    var k = m.dataSet.fieldMappings[g],
                                                        c = m.dataSet.id + '_' + k.toField;
                                                    (b.data[p][c] =
                                                        m.dataSet.dataProvider[f][k.fromField]),
                                                        b.titles[c] || j(c, m.dataSet.title);
                                                }
                                        }
                                    }
                                }
                            } else if ('gantt' == d.setup.chart.type) {
                                j(d.setup.chart.categoryField),
                                    b.dateFields.push(d.setup.chart.categoryField);
                                var q = d.setup.chart.segmentsField;
                                for (e = 0; e < d.setup.chart.dataProvider.length; e++) {
                                    var r = d.setup.chart.dataProvider[e];
                                    if (r[q])
                                        for (f = 0; f < r[q].length; f++)
                                            (r[q][f][d.setup.chart.categoryField] =
                                                r[d.setup.chart.categoryField]),
                                                b.data.push(r[q][f]);
                                }
                            ...
                            } else if (['pie', 'funnel'].indexOf(d.setup.chart.type) != -1)
                                (b.data = d.setup.chart.dataProvider),
                                    j(d.setup.chart.titleField),
                                    b.dateFields.push(d.setup.chart.titleField),
                                    j(d.setup.chart.valueField);
                                ...
                                for (
                                    b.data = d.setup.chart.dataProvider,
                                        d.setup.chart.categoryAxis &&
                                            ...
                                            d.setup.chart.categoryAxis.parseDates !== !1 &&
                                                b.dateFields.push(d.setup.chart.categoryField)),
                                        e = 0;
                                    e < d.setup.chart.graphs.length;
                                    e++
                                ) {
                                    var m = d.setup.chart.graphs[e];
                                    for (f = 0; f < h.length; f++) {
                    ...
                    setAnnotations: function (a, b) {
                        ...
                        return (
                            fabric.util.enlivenObjects(c.data, function (a) {
                    ...
                    processData: function (b) {
                        ...
                        if (c.data.length) {
                            for (e = 0; e < c.data.length; e++)
                                for (f in c.data[e])
                                    c.dataFields.indexOf(f) == -1 &&
                                        (c.dataFields.push(f), (c.dataFieldsMap[f] = f));
                            void 0 !== c.exportFields &&
                                (c.dataFields = c.exportFields.filter(function (a) {
                                ...
                                for (f = 0; f < c.dataFields.length; f++) {
                                    ...
                                    null == m && (m = void 0),
                                        c.exportTitles &&
                                            ...
                                            l in h &&
                                            (l += ['( ', j, ' )'].join('')),
                                        c.dateFields.indexOf(k) != -1 &&
                                            (c.dataDateFormat &&
                                            (m instanceof String || 'string' == typeof m)
                                                ? (m = AmCharts.stringToDate(m, c.dataDateFormat))
                                                : c.dateFormat &&
                                                  (m instanceof Number || 'number' == typeof m) &&
                                                  (m = new Date(m)),
                                            c.exportSelection &&
                                                (m instanceof Date
                                                    ? (m < a.startDate || m > a.endDate) && (i = !0)
                                                    : (e < a.startIndex || e > a.endIndex) &&
                                                      (i = !0)),
                                            c.dateFormat &&
                                                'dateObject' != c.dateFormat &&
                                                m instanceof Date &&
                                                (m = AmCharts.formatDate(m, c.dateFormat))),
                                        (c.dataFieldsTitlesMap[k] = l),
                                        (h[l] = m);
                                }
                                i || g.push(h);
                            }
                        ...
                        return (
                            void 0 !== c.processData &&
                                (c.data = d.handleCallback(c.processData, c.data, c)),
                            c.data
                        );
                    },
                    ...
                    createMenu: function (b, c) {
                        function g(b, c) {
                            ...
                            for (e = 0; e < b.length; e++) {
                                var j = 'string' == typeof b[e] ? { format: b[e] } : b[e],
                                ...
                                if (
                                    ...
                                    l.addEventListener('focus', function (a) {
                                        d.setup.hasTouch ||
                                    ...
                                    d.config.formats[j.format]
                                        ...
                                        : j.label ||
                                          (j.label = j.label ? j.label : d.i18l('menu.label.' + o)),
                                    (['CSV', 'JSON', 'XLSX'].indexOf(j.format) == -1 ||
                                        ['map', 'gauge'].indexOf(d.setup.chart.type) == -1) &&
                                        (d.setup.hasBlob ||
                                            'UNDEFINED' == j.format ||
                                            !j.mimeType ||
                                            'image' == j.mimeType.split('/')[0] ||
                                            'text/plain' == j.mimeType))
                                ) {
                                    if ('draw' == j.action)
                                        ...
                                        for (
                                            ...
                                            if ('shapes' == p) {
                                                ...
                                                (r.action = 'add'),
                                                    ...
                                                    (r.icon = t),
                                                    (r.ignore = s),
                                                    (r.class = 'export-drawing-shape');
                                            } else
                                                'colors' == p
                                                    ? ((r.style = 'background-color: ' + q[h]),
                                                      (r.action = 'change'),
                                                      (r.color = q[h]),
                                                      (r.class = 'export-drawing-color'))
                                                    : 'widths' == p
                                                    ? ((r.action = 'change'),
                                                      (r.width = q[h]),
                                                      (r.label = document.createElement('span')),
                                                      (r.label.style.width = d.numberToPx(q[h])),
                                                      (r.label.style.height = d.numberToPx(q[h])),
                                                      (r.class = 'export-drawing-width'))
                                                    : 'opacities' == p
                                                    ? ((r.style = 'opacity: ' + q[h]),
                                                      (r.action = 'change'),
                                                      (r.opacity = q[h]),
                                                      (r.label = 100 * q[h] + '%'),
                                                      (r.class = 'export-drawing-opacity'))
                                                    : 'modes' == p &&
                                                      ((r.label = d.i18l(
                                                          'menu.label.draw.modes.' + q[h],
                                                      )),
                                                      (r.click = (function (a) {
                                                          return function () {
                                                              d.drawing.mode = a;
                                        ...
                                        j.click ||
                                            j.menu ||
                                            j.items ||
                                            (d.drawing.handler[o] instanceof Function
                                                ? ((j.action = o),
                                                  (j.click = (function (a) {
                                                      return function () {
                                    ...
                                    (void 0 === j.menu || j.menu.length) &&
                                            ...
                                            (function (a, b) {
                                                return function (c) {
                                                    ...
                                                    return !(
                                                        'draw' == b.action ||
                                                        'PRINT' == b.format ||
                                                        ('UNDEFINED' != b.format && b.capture)
                                                    ) ||
                                                        d.drawing.enabled ||
                                                        (isNaN(b.delay) && isNaN(d.config.delay))
                                                        ? void a.apply(d, e)
                                                        : ((b.delay = isNaN(b.delay)
                                                              ? d.config.delay
                                                              : b.delay),
                                                          void d.delay(b, a));
                                                };
                                                    ...
                                                    return function (b) {
                                                        ...
                                                        function k(a) {
                                                            ...
                                                            for (e = 0; e < b.length; e++) {
                                                                var c = b[e],
                                                                    d = c.classList;
                                                                if (c !== a && d.contains('active'))
                                                                    return d.remove('active'), !0;
                                                            }
                                                            return !1;
                                                        }
                                                        function l(a) {
                                                        ...
                                                        f.push(c),
                                                            i && c.classList.toggle('active');
                                                    };
                                                })(j),
                                            ),
                                        k.appendChild(l),
                                        d.isElement(j.label)
                                            ? n.appendChild(j.label)
                                            : (n.innerHTML = j.label),
                                        j.class && (k.className = j.class),
                                        j.style && k.setAttribute('style', j.style),
                                        j.icon &&
                                            (m.setAttribute(
                                                'src',
                                                (j.ignore || j.icon.slice(0, 10).indexOf('//') != -1
                                                    ? ''
                                                    : a.pathToImages) + j.icon,
                                            ),
                                            l.appendChild(m)),
                                        j.label && l.appendChild(n),
                                        j.title && l.setAttribute('title', j.title),
                                        d.config.menuReviver &&
                                            (k = d.config.menuReviver.apply(d, [j, k])),
                                        (j.elements = {
                                            li: k,
                                            a: l,
                                            img: m,
                                        ...
                                        (j.menu || j.items) && 'draw' != j.action
                                            ? g(j.menu || j.items, k).childNodes.length &&
                                              i.appendChild(k)
                                            : i.appendChild(k));
                                }
                            }
                        ...
                        return (
                            c ||
                                ('string' == typeof d.config.divId
                                    ? (d.config.divId = c = document.getElementById(d.config.divId))
                                    : (c = d.isElement(d.config.divId)
                                          ? d.config.divId
                            ...
                            d.config.menuWalker && (g = d.config.menuWalker),
                            g.apply(this, [b, d.setup.menu]),
                            d.setup.menu.childNodes.length && c.appendChild(d.setup.menu),
                            d.setup.menu
                        );
                    },
                    delay: function (a, b) {
                        var e,
                            f,
                            c = d.deepMerge({ delay: 3, precision: 2 }, a || {}),
                            g = Number(new Date()),
                            h = d.createMenu([
                                {
                                    label: d
                                        ...
                                        .replace(
                                            '{{duration}}',
                                            AmCharts.toFixed(c.delay, c.precision),
                                        ),
                        ...
                        (e = setInterval(function () {
                            ...
                            a <= 0
                                ? (clearTimeout(e),
                                  'draw' != c.action && d.createMenu(d.config.menu))
                                : i &&
                                  (i.innerHTML = d
                                      .i18l('capturing.delayed.menu.label')
                                      .replace('{{duration}}', AmCharts.toFixed(a, 2)));
                        }, AmCharts.updateRate)),
                    ...
                    migrateSetup: function (a) {
                        function c(a) {
                            ...
                            for (d in a) {
                                var e = a[d];
                                'export' == d.slice(0, 6) && e
                                    ? b.menu.push(d.slice(6))
                                    : 'userCFG' == d
                                    ? c(e)
                                    : 'menuItems' == d
                                    ? (b.menu = e)
                    ...
                    clear: function () {
                        (d.setup = void 0),
                            d.docListener && document.removeEventListener('keydown', d.docListener);
                            ...
                            ((d.docListener = function (b) {
                                ...
                                function m() {
                                    function a(b) {
                                        d.isElement(b) &&
                                            (b.blur(),
                                            b.parentNode && b.parentNode.classList.remove('active'),
                                            b.classList.contains('amExportButton') ||
                                                a(b.parentNode));
                                    }
                                    d.setup.focusedMenuItem &&
                                        (a(d.setup.focusedMenuItem),
                                        (d.setup.focusedMenuItem = void 0));
                                }
                                var c = d.drawing.buffer.target,
                                    e = [37, 38, 39, 40, 13, 9, 27],
                                    g =
                                ...
                                if (d.setup.focusedMenuItem && e.indexOf(b.keyCode) != -1) {
                                    ...
                                    13 == b.keyCode && d.setup.focusedMenuItem.nextSibling && i(),
                                        37 == b.keyCode && (g ? i() : j()),
                                        39 == b.keyCode && (g ? j() : i()),
                                        40 == b.keyCode && k(),
                                        38 == b.keyCode && l(),
                                ...
                                (8 != b.keyCode && 46 != b.keyCode) || !c
                                    ? 27 == b.keyCode && d.drawing.enabled
                                        ? (b.preventDefault(),
                                          d.drawing.buffer.isSelected
                                              ? d.setup.fabric.discardActiveObject()
                                              : d.drawing.handler.done())
                                        : 67 == b.keyCode && (b.metaKey || b.ctrlKey) && c
                                        ? (d.drawing.buffer.copy = c)
                                        : 88 == b.keyCode && (b.metaKey || b.ctrlKey) && c
                                        ? ((d.drawing.buffer.copy = c), d.setup.fabric.remove(c))
                                        : 86 == b.keyCode && (b.metaKey || b.ctrlKey)
                                        ? d.drawing.buffer.copy && a(d.drawing.buffer.copy.clone(a))
                                        : 90 == b.keyCode &&
                                          (b.metaKey || b.ctrlKey) &&
                                          (b.preventDefault(),
                                          b.shiftKey
                                    ...
                                    : (b.preventDefault(), d.setup.fabric.remove(c));
                            }),
                    ...
                    construct: function () {
                        ...
                        (window.safari = window.safari ? window.safari : {}),
                            (d.defaults.fabric.drawing.fontSize = d.setup.chart.fontSize || 11),
