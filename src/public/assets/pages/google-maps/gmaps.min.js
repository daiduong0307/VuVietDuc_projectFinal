...
!(function (a, b) {
    ...
    (j.prototype.createControl = function (a) {
        ...
        a.id && (b.id = a.id),
            ...
            a.content &&
                ('string' == typeof a.content
                    ...
                    : a.content instanceof HTMLElement &&
                      b.appendChild(a.content)),
            a.position &&
                (b.position =
                    google.maps.ControlPosition[a.position.toUpperCase()]);
        ...
        (j.prototype.addControl = function (a) {
            ...
            return (
                this.controls.push(b), this.map.controls[b.position].push(b), b
            );
        }),
                ...
                if (this.markers[b] === a) {
                    this.markers[b].setMap(null),
                        ...
                        this.markerClusterer &&
                            this.markerClusterer.removeMarker(a),
        ...
        (j.prototype.removeMarkers = function (a) {
            ...
            if ('undefined' == typeof a) {
                for (var c = 0; c < this.markers.length; c++) {
                    ...
                    d.setMap(null),
                        this.markerClusterer &&
                            this.markerClusterer.removeMarker(d),
        ...
        (j.prototype.addLayer = function (a, b) {
            ...
            switch (a) {
                case 'weather':
                    ...
                    break;
                case 'clouds':
                    this.singleLayers.clouds = c =
                        new google.maps.weather.CloudLayer();
                    break;
                case 'traffic':
                    this.singleLayers.traffic = c =
                        new google.maps.TrafficLayer();
                    break;
                case 'transit':
                    this.singleLayers.transit = c =
                        new google.maps.TransitLayer();
                    break;
                case 'bicycling':
                    this.singleLayers.bicycling = c =
    ...
    return (
            ...
            f.route(d, function (a, c) {
                if (c === google.maps.DirectionsStatus.OK) {
                    for (var d in a.routes)
                        a.routes.hasOwnProperty(d) &&
                            e.routes.push(a.routes[d]);
                ...
                this.getRoutes({
                    ...
                    callback: function (b) {
                        if (
                            (b.length > 0 &&
                                a.start &&
                                a.start(b[b.length - 1]),
                            b.length > 0 && a.step)
                        ) {
                            var c = b[b.length - 1];
                            if (c.legs.length > 0)
                                for (
                                    var d, e = c.legs[0].steps, f = 0;
                                    (d = e[f]);
                                    f++
                                )
                                    (d.step_number = f),
                ...
                this.getRoutes({
                    ...
                    callback: function (c) {
                        if (
                            (c.length > 0 &&
                                a.start &&
                                a.start(c[c.length - 1]),
                            c.length > 0 && a.step)
                        ) {
                            var d = c[c.length - 1];
                            if (d.legs.length > 0)
                                for (
                                    var e, f = d.legs[0].steps, g = 0;
                                    (e = f[g]);
                                    g++
                                ) {
                                    e.step_number = g;
        ...
        (j.staticMapURL = function (a) {
                ...
                for (var m, n, o = 0; (c = f[o]); o++) {
                    (m = []),
                        c.size && 'normal' !== c.size
                            ...
                            : c.icon &&
                              (m.push('icon:' + encodeURI(c.icon)),
                              delete c.icon),
                        c.color &&
                            (m.push('color:' + c.color.replace('#', '0x')),
                            delete c.color),
                        c.label &&
                            (m.push('label:' + c.label[0].toUpperCase()),
                            delete c.label),
            ...
            if (h) {
                if (
                    ...
                    (h = []),
                    c.strokeWeight &&
                        h.push('weight:' + parseInt(c.strokeWeight, 10)),
                    c.strokeColor)
                ) {
        ...
        google.maps.Polygon.prototype.containsLatLng ||
            (google.maps.Polygon.prototype.containsLatLng = function (a) {
                ...
                for (
                    var c = !1, d = this.getPaths().getLength(), e = 0;
                    d > e;
                    e++
                )
                    for (
