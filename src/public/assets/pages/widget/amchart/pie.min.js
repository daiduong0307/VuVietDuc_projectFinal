(function () {
    ...
    a.AmSlicedChart = a.Class({
        ...
        formatString: function (f, e, h) {
            ...
            this.pf.precision = g;
            -1 != f.indexOf('[[') &&
                (f = a.formatDataContextValue(f, e.dataContext));
        ...
        rollOverSlice: function (i, e, n) {
            ...
            if (!i.hidden) {
                ...
                1 > this.hoverAlpha &&
                    i.wedge &&
                    i.wedge.attr({ opacity: this.hoverAlpha });
                var m = i.balloonX,
                    k = i.balloonY;
        ...
        pullSlice: function (f, e, h) {
            ...
            if ((h = f.wedge)) {
                0 < g
                    ...
                    : (f.labelSet &&
                          f.labelSet.translate(e * f.pullX, e * f.pullY),
                      h.translate(e * f.pullX, e * f.pullY));
            }
            1 == e
                ? ((f.pulled = !0),
                  this.pullOutOnlyOne && this.pullInAll(f.index),
                  (f = { type: 'pullOutSlice', dataItem: f, chart: this }))
                : ((f.pulled = !1),
                  (f = { type: 'pullInSlice', dataItem: f, chart: this }));
            this.fire(f);
        },
        ...
        parseData: function () {
            ...
            if (void 0 !== i) {
                ...
                for (l = 0; l < p; l++) {
                    ...
                    var n = i[l];
                    m.dataContext = n;
                    null !== n[this.valueField] &&
                        (m.value = Number(n[this.valueField]));
                ...
                for (l = i = 0; l < p; l++) {
                    (m = j[l]),
                        (m.percents = (m.value / o) * 100),
                        m.percents < this.groupPercent && i++;
                }
                1 < i &&
                    ((this.groupValue = 0),
                ...
                for (l = 0; l < j.length; l++) {
                    p
                        ? (k = a.adjustLuminosity(p, (l * o) / 100))
                        : ((k = this.colors[l]),
                          void 0 === k && (k = a.randomColor())),
        ...
        recalculatePercents: function () {
            ...
            for (h = 0; h < f.length; h++) {
                (g = this.chartData[h]),
                    (g.percents =
                        !g.hidden && 0 < g.value ? (100 * g.value) / e : 0);
            }
        },
        removeSmallSlices: function () {
            ...
            for (c = d.length - 1; 0 <= c; c--) {
                d[c].percents < this.groupPercent &&
                    ((this.groupValue += d[c].value), d.splice(c, 1));
            }
        },
        animateAgain: function () {
            ...
            for (var e = 0; e < f.chartData.length; e++) {
                ...
                var g = h.wedge;
                g &&
                    (g.setAttr('opacity', f.startAlpha),
                    g.translate(h.startX, h.startY));
                if ((g = h.labelSet)) {
                    g.setAttr('opacity', f.startAlpha),
                        g.translate(h.startX, h.startY);
                }
            ...
            if (a.ifArray(Z)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    for (S = M = 0; S < Z.length; S++) {
                        (V = Z[S]),
                            !0 !== V.hidden &&
                                (M += a.roundTo(V.percents, this.pf.precision));
                    }
                    ...
                    for (var H, S = 0; S < Z.length; S++) {
                        if (
                            ((V = Z[S]),
                            !0 !== V.hidden &&
                                (this.showZeroSlices || 0 !== V.percents))
                        ) {
                            var K = (360 * V.percents) / 100,
                                M = Math.sin(((P + K / 2) / 180) * Math.PI),
                                J =
                                    (W / Q) *
                                    -Math.cos(((P + K / 2) / 180) * Math.PI),
                                N = this.outlineColor;
                            N || (N = V.color);
                            var F = this.alpha;
                            ...
                            0 < Y &&
                                (this.chartCreated ||
                                    N.setAttr('opacity', this.startAlpha));
                            V.ix = M;
                            V.iy = J;
                            V.wedge = N;
                            V.index = S;
                            ...
                            if (
                                this.labelsEnabled &&
                                this.labelText &&
                                V.percents >= this.hideLabelsPercent
                            ) {
                                var R = P + K / 2;
                                0 > R && (R += 360);
                                360 < R && (R -= 360);
        ...
        arrangeLabels: function () {
            ...
            for (g = e - 1; 0 <= g; g--) {
                (h = f[g]),
                    0 !== h.labelQuarter ||
                        h.hidden ||
                        this.checkOverlapping(g, h, 0, !0, 0);
            }
            for (g = 0; g < e; g++) {
                (h = f[g]),
                    1 != h.labelQuarter ||
                        h.hidden ||
                        this.checkOverlapping(g, h, 1, !1, 0);
            }
            for (g = e - 1; 0 <= g; g--) {
                (h = f[g]),
                    2 != h.labelQuarter ||
                        h.hidden ||
                        this.checkOverlapping(g, h, 2, !0, 0);
            }
            for (g = 0; g < e; g++) {
                (h = f[g]),
                    3 != h.labelQuarter ||
                        h.hidden ||
                        this.checkOverlapping(g, h, 3, !1, 0);
            }
        },
        checkOverlapping: function (t, s, r, q, m) {
            ...
            if (i) {
                if (!0 === q) {
                    for (l = t + 1; l < j; l++) {
                        p[l].labelQuarter == r &&
                            (o = this.checkOverlappingReal(s, p[l], r)) &&
                            (l = j);
                    }
                } else {
                    for (l = t - 1; 0 <= l; l--) {
                ...
                !0 === o &&
                    ...
                    ((o = s.ty + 3 * s.iy),
                    (s.ty = o),
                    i.translate(s.textX, o),
                    this.checkOverlapping(t, s, r, q, m + 1));
            }
        },
