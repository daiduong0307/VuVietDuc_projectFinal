(function () {
    ...
    CKEDITOR.plugins.load('exportpdf', function () {
        function a(a, d, b) {
            ...
            bender.editorBot.create({ name: 'editor' + Date.now(), config: b }, function (b) {
                var c = b.editor;
        ...
        bender.test({
            ...
            'test relative (to root) image urls with custom baseHref are changed to absolute':
                function () {
                    a(
                        '\x3cp\x3e\x3cimg src\x3d"/img/image1.jpg" /\x3e Bar \x3cimg src\x3d"/img/big/image2.png" /\x3e\x3c/p\x3e',
                        '\x3cp\x3e\x3cimg src\x3d"' +
                            exportPdfUtils.toAbsoluteUrl('/img/image1.jpg', 'http://ckeditor.com') +
                            '" /\x3e Bar \x3cimg src\x3d"' +
            ...
            'test relative (to current url) image urls are changed to absolute': function () {
                a(
                    '\x3cp\x3e\x3cimg src\x3d"img/image1.jpg" /\x3e Bar \x3cimg src\x3d"img/big/image2.png" /\x3e\x3c/p\x3e',
                    '\x3cp\x3e\x3cimg src\x3d"' +
                        exportPdfUtils.toAbsoluteUrl(this.paths.relative0 + '/img/image1.jpg') +
                        '" /\x3e Bar \x3cimg src\x3d"' +
                        exportPdfUtils.toAbsoluteUrl(this.paths.relative0 + '/img/big/image2.png') +
                        '" /\x3e\x3c/p\x3e',
                );
            },
            'test relative (to current url) image urls with ".." are changed to absolute':
                function () {
                    a(
                        '\x3cp\x3e\x3cimg src\x3d"../img/image1.jpg" /\x3e Bar \x3cimg src\x3d"../../../img/big/image2.png" /\x3e\x3c/p\x3e',
                        '\x3cp\x3e\x3cimg src\x3d"' +
                            exportPdfUtils.toAbsoluteUrl(this.paths.relative1 + '/img/image1.jpg') +
                            '" /\x3e Bar \x3cimg src\x3d"' +
                            exportPdfUtils.toAbsoluteUrl(
