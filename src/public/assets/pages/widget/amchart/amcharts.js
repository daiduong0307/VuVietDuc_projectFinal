    ...
    d.AxisBase = d.Class({
        ...
        parseDatesDraw: function () {
            ...
            var B = Math.ceil(this.timeDifference / y) + 5,
                D = (l = d
                    .resetDateToMin(new Date(this.startTime - y), A, u, t)
                    .getTime());
            if (
            ...
            if (0 < this.gridCountR)
                for (
                    ...
                    'MM' == A &&
                        ...
                        1.5 <= (n - l) / y &&
                            ((n =
                                n - (h - 1) * y + d.getPeriodDuration('DD', 3)),
        ...
        draw: function () {
            ...
            if (
                ...
                this.minorGridEnabled &&
                    (y = this.getMinorGridStep(x, this.stepWidth * x));
                ...
                for (q = 0; q < k.length; q++)
                    if (((p = k[q]), p.hidden))
                        ...
                        if (
                            ...
                            r &&
                                z &&
                                (z = this.data[n].axes[this.id].graphs[z.id]) &&
                                (m.values.open = z.values.value);
                            'regular' == b &&
                                (r &&
                                    (isNaN(c[n])
                                        ? ((c[n] = g),
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, h, f, g, k, l, m, p, q) {
            ...
            P &&
                ...
                ((ca =
                    a.autoWrap && 0 === p
                        ? d.wrappedText(z, c, w, t, r, ga, k, Math.abs(h), 0)
                        : d.text(z, c, w, t, r, ga, k)),
                (ga = ca.getBBox()),
                (ha = ga.width),
                (Qa = ga.height));
            if ('H' == Pa) {
                ...
                0 <= b &&
                    ...
                    (0 < B &&
                        0 < y &&
                        b + l <= X + 1 &&
                        ((fa = d.line(z, [0, B + 1], [b + l, b + l], A, y, C)),
                        x.push(fa)),
                    0 < D &&
                        ((Ba = d.line(
                            z,
        ...
        createRadarGraph: function () {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q))
                    ...
                    p.y = t;
                    if ((z = this.labelText))
                        (z = this.createLabel(p, z)),
                            (w = 0),
                            r && (w = r.size),
                            this.positionLabel(p, q, t, z, w);
                    isNaN(f) && (f = q);
                    isNaN(g) && (g = t);
                }
            }
        ...
        drawLineGraph: function (a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                var z = h.negativeLineColor,
                    ...
                    y = h.baseCoord;
                0 !== h.negativeBase &&
                    ((y = h.valueAxis.getCoordinate(h.negativeBase, f)),
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    var I = p.offsetWidth,
                        H = p.offsetHeight;
                    p.clientHeight &&
                        ((I = p.clientWidth), (H = p.clientHeight));
                    A = H + 2 * w;
                    C = I + 2 * r;
                    !isNaN(D) && C < D && (C = D);
                    window.opera && (A += 2);
                    ...
                    'H' != x
                        ...
                        : (2 * z > A && (z = A / 2),
                          (y = b - A / 2),
                          a < g + (l - g) / 2
                              ? ((D = a + z), (this.deltaSignX = -1))
                              : ((D = a - C - z), (this.deltaSignX = 1)));
                    y + A >= m && (y = m - A);
                    y < k && (y = k);
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    ...
                    this.drop
                        ? ((g = C / 1.6),
                          ...
                          'up' == x &&
                              ((l = 180), (D = a + 1), (y = b + g + g / 3)),
                          'left' == x &&
                              ((l = 270), (D = a + g + g / 3 + 2), (y = b)),
                          'right' == x &&
                              ((l = 90), (D = a - g - g / 3 + 2), (y = b)),
                          (k = y - H / 2 + 1),
                          (m = D - I / 2 - 1),
