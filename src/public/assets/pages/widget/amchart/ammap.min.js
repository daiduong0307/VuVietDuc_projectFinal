...
(function () {
    ...
    a.wordwrap = function (i, d, p, o) {
        ...
        for (i = (j = i.split(/\r\n|\n|\r/)).length; ++n < i; j[n] += l) {
            ...
            for (
                j[n] = '';
                l.length > d;
                j[n] += a.trim(l.slice(0, m)) + ((l = l.slice(m)).length ? p : '')
            ) {
                m =
    ...
    a.formatDuration = function (r, q, p, o, n, m) {
        ...
        if (r >= j[q].contains) {
            ...
            'ss' == q
                ? ((d = a.formatNumber(d, m)), 1 == d.split(i)[0].length && (d = '0' + d))
        ...
        if (u) {
            ...
            for (j = 0; j < t.length; j++) {
                ...
                void 0 !== d &&
                    ...
                    (v = v.replace(new RegExp('\\[\\[' + r + '' + i + '\\]\\]', 'g'), d)));
            }
        }
        return v;
    };
    ...
    a.processObject = function (g, d, j, i) {
        if (
            !1 === g instanceof d &&
            ((g = i ? a.extend(new d(j), g) : a.extend(g, new d(j), !0)), g.listeners)
        ) {
    ...
    a.AmChart = a.Class({
        ...
        drawLabel: function (v) {
            ...
            if (u.container && !1 !== v.enabled) {
                ...
                'center' == r &&
                    ((r = 'middle'),
                    o ? (t = u.realHeight - t + t / 2) : (d = u.realWidth / 2 - d));
                void 0 === j && (j = 1);
                void 0 === o && (o = 0);
                t += q / 2;
        ...
        handleMouseMove: function (h) {
            ...
            if (h) {
                ...
                isNaN(j)
                    ? (this.mouseX = f)
                    : ((this.mouseX = Math.min(f, j)), (this.mouse2X = Math.max(f, j)));
                isNaN(k)
                    ? (this.mouseY = l)
        ...
        draw: function () {
            ...
            if (!isNaN(al)) {
                ...
                if (this.show) {
                    ...
                    this.className &&
                        (ab.className = ab.className + ' ' + V + '-balloon-div-' + this.className);
                    V = ab.style;
                    ...
                    this.drop
                        ...
                        ? (0 < O &&
                              ...
                              a.isModern ? al.translate(1, 1) : al.translate(4, 4),
                              ag.push(al)),
        ...
        drawLegend: function () {
            ...
            'outside' == d
                ...
                : (isNaN(p) || (m.style.width = p + 'px'),
                  (m.className = 'amChartsLegend ' + i.classNamePrefix + '-legend-div'));
            this.divWidth = p;
            (d = this.container)
        ...
        arrangeEntries: function () {
            ...
            for (s = 0; s < G.length; s++) {
                ...
                H + o.width > O &&
                    0 < s &&
                    0 !== N &&
                    (K++, (H = N = 0), (J = H + o.width + U + P), (j = j + d + Q), (d = 0));
            ...
            if (!1 !== L.visibleInLegend && !L.hideFromLegend) {
                ...
                if (I) {
                    ...
                    if (A) {
                        ...
                        (C = K.createMarker(H, G, F, void 0, void 0, void 0, v, D)) &&
                            C.translate(o / 2, o / 2);
                    }
                }
            ...
            if (!1 !== r.visibleInLegend && !r.hideFromLegend) {
                ...
                if (q.valueText && 0 < q.valueWidth) {
                    ...
                    q.useMarkerColorForValues &&
                        ((j = r.color), r.legendKeyColor && (j = r.legendKeyColor()));
            ...
            if (v) {
                for (t = 0; t < v.length; t++) {
                    ...
                    if (s) {
                        ...
                        if (
                            !q.pattern &&
                            (this.useMarkerColorForValues && r.setAttr('fill', d),
                            this.useMarkerColorForLabels)
                        ) {
                            if ((r = q.legendMarker)) {
...
(function () {
    ...
    a.AmMap = a.Class({
        ...
        drawChart: function () {
            ...
            e.mapVar && (f = e.mapVar);
            f
                ? ((this.svgData = f.svg), this.getBounds(), this.buildEverything())
        ...
        buildEverything: function () {
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                if ((d = this.valueLegend)) {
                    (this.valueLegend = d = a.processObject(d, a.ValueLegend, this.theme)),
                        d.init(this, e);
                }
                this.objectList &&
                    (e = this.objectList = a.processObject(this.objectList, a.ObjectList)) &&
            ...
            if (this.areasSettings.adjustOutlineThickness) {
                for (var f = this.svgAreas, k = 0; k < f.length; k++) {
                    (l = f[k]) &&
                        l.setAttr(
                            'stroke-width',
                            this.areasSettings.outlineThickness / h / this.mapScale,
                        );
                }
        ...
        rescaleObjects: function () {
            ...
            for (l = 0; l < e.length; l++) {
                (k = e[l]),
                    k.imageLabel &&
                        this.imagesProcessor.positionLabel(k.imageLabel, k, k.labelPositionReal);
            }
        ...
        selectObject: function (x, w) {
            ...
            if (u) {
                if (
                    ...
                    x.selectable ||
                        (u.setAttr('cursor', 'default'), o && o.setAttr('cursor', 'default'));
                }
            } else {
            ...
            if ((u = x.groupId)) {
                for (
                    o = x.groupArray, o || ((o = v.getGroupById(u)), (x.groupArray = o)), j = 0;
                    j < o.length;
                    j++
                ) {
                    if (
            ...
            if (!g.showAsSelected && d && !g.isOver) {
                ...
                void 0 == j &&
                    (isNaN(g.rollOverBrightnessReal) ||
                        (j = a.adjustLuminosity(g.colorReal, g.rollOverBrightnessReal / 100)));
                if (void 0 != j) {
                ...
                (j = g.imageLabel) &&
                    !g.labelInactive &&
                    ((i = g.labelRollOverColorReal), void 0 != i && j.setAttr('fill', i));
                ...
                'MapImage' == g.objectType
                    ? ((j = this.imagesSettings.rollOverOutlineThickness),
                      (i = g.image) && (isNaN(j) || i.setAttr('stroke-width', j)))
            ...
            if (this.chartCreated) {
                ...
                i && i != g
                    ? (!1 === this.checkIfSelected(i) &&
                          (this.returnInitialColor(i, !0), (this.previouslyHovered = null)),
                      this.balloon.hide(0))
                ...
                if (!this.preventHover) {
                    ...
                    this.showDescriptionOnHover
                        ...
                        : (!this.showBalloonOnSelectedObject && this.checkIfSelected(g)) ||
                          ...
                          i &&
                              '' !== i &&
                              this.showBalloon(i, e, !1, this.balloonX, this.balloonY));
                    this.fire({
        ...
        longitudeToX: function (b) {
            return (
                (this.longitudeToCoordinate(b) + this.diffX * this.mapScale) * this.zoomLevel() +
                this.mapContainer.x
            );
        },
        latitudeToY: function (b) {
            return (
                (this.latitudeToCoordinate(b) + this.diffY * this.mapScale) * this.zoomLevel() +
                this.mapContainer.y
            );
        },
        ...
        zoomX: function () {
            return this.mapSet
                ? Math.round((10000 * this.mapContainer.x) / this.mapWidth) / 10000
                : NaN;
        },
        zoomY: function () {
            return this.mapSet
                ? Math.round((10000 * this.mapContainer.y) / this.mapHeight) / 10000
                : NaN;
        },
        goHome: function () {
            this.selectObject(this.dataProvider);
        ...
        longitudeToCoordinate: function (e) {
            ...
            var d,
                f = this.dataProvider;
            this.mapSet &&
                ((d = f.leftLongitude), (d = ((e - d) / (f.rightLongitude - d)) * this.mapWidth));
            return d;
        },
                                ...
                                void 0 !== x[w][o]
                                    ? void 0 === x[w][o].length
                                        ? ((e = x[w][o]),
                                          ...
                                          (e = x[w][o][1]))
                                        : 'object' == typeof x[w][o] &&
                                          (x[w][o].push({}), (e = x[w][o][x[w][o].length - 1]))
                                    : ((x[w][o] = {}), (e = x[w][o]));
        ...
        x2c: function (d) {
            ...
            return (
                Math.round(
                    ((this.unscaledMapWidth * (d - c)) / (this.dataProvider.rightLongitude - c)) *
                        100,
                ) / 100
            );
        },
        y2c: function (d) {
            ...
            return (
                Math.round(
                    ((this.unscaledMapHeight * (d - c)) / (this.dataProvider.bottomLatitude - c)) *
                        100,
                ) / 100
            );
        },
        ...
        redrawArea: function (i) {
            for (var d = !1, p = '', o = 0; o < i.length; o++) {
                ...
                l < this.minMapXX &&
                    ((this.minMapXX = l), (this.leftLongLat = { longitude: n, latitude: m }));
                l > this.maxMapXX &&
                    ((this.maxMapXX = l), (this.rightLongLat = { longitude: n, latitude: m }));
                j < this.minMapYY &&
                    ((this.minMapYY = j), (this.topLongLat = { longitude: n, latitude: m }));
                j > this.maxMapYY &&
                    ((this.maxMapYY = j), (this.bottomLongLat = { longitude: n, latitude: m }));
                d ? (p += ' L ') : ((p += ' M '), (d = !0));
                p += l + ' ' + j;
            }
            return p + ' Z ';
    ...
    a.ZoomControl = a.Class({
        ...
        init: function (af, ae) {
            ...
            isNaN(ad.bottom) ||
                ...
                aa && (d -= S + 3 * ab),
                (d = Z ? d - 3 * ab : ad.homeButtonEnabled ? d - 0.5 * ab : d + ab));
            ac.translate(j, d);
            ad.previousDY = NaN;
            var K,
                j = ab / 4 - 1;
            if (aa) {
                ...
                for (I = 1; I < o; I++) {
                    (d = ab + I * aa),
                        (d = a.line(ae, [1, M - 2], [d, d], ad.gridColor, ad.gridAlpha, 1)),
...
(function () {
    ...
    a.SimpleButton = a.Class({
        ...
        init: function (C, B, A, z, y, x, w, v, u, s, o, j, D) {
            ...
            d.set = s;
            D
                ? ((B /= 2), (z = a.circle(C, B, z, y, x, w, v)), z.translate(B, B))
    ...
    a.SmallMap = a.Class({
        ...
        init: function (C, B) {
            ...
            if (A.enabled) {
                ...
                isNaN(A.bottom) ||
                    ((u = C.getY(A.bottom, !0) - A.height - x), (i = A.height - v + x / 2));
                isNaN(A.left) || ((s = C.getX(A.left) + x), (d = -x / 2));
                isNaN(A.right) ||
                    ((s = C.getX(A.right, !0) - A.width - x), (d = A.width - v + x / 2));
                x = B.set();
        ...
        buildSVGMap: function () {
            ...
            var m = -d.y * p,
                ...
                j = 0;
            i.centerMap &&
                ((l = (this.width - d.width * p) / 2), (j = (this.height - d.height * p) / 2));
        ...
        update: function () {
            ...
            if (i) {
                ...
                0 < n &&
                    0 < m &&
                    (j.setAttr('width', Math.ceil(n + 1)), j.setAttr('height', Math.ceil(m + 1)));
                this.rWidth = n;
                this.rHeight = m;
            }
        },
    ...
    a.AreasProcessor = a.Class({
        ...
        process: function (r) {
            ...
            for (o = 0; o < p; o++) {
                (n = r[o]),
                    isNaN(n.value)
                        ? (n.percents = void 0)
                        : ((n.percents = ((n.value - i) / m) * 100), i == j && (n.percents = 100));
            }
            for (o = 0; o < p; o++) {
        ...
        createArea: function (R) {
            ...
            void 0 == O.colorSolid ||
                isNaN(R.value) ||
                ((E = Math.floor(
                    (R.value - this.minValue) / ((this.maxValue - this.minValue) / Q.colorSteps),
                )),
                E == Q.colorSteps && E--,
                (E *= 1 / (Q.colorSteps - 1)),
            ...
            isNaN(O.selectedBrightness) ||
                (D = a.adjustLuminosity(R.colorReal, O.selectedBrightness / 100));
            R.alphaReal = F;
    ...
    a.ImagesProcessor = a.Class({
        ...
        createImage: function (af, ae) {
            ...
            isNaN(Z.selectedBrightness) ||
                (W = a.adjustLuminosity(af.colorReal, Z.selectedBrightness / 100));
            af.alphaReal = Y;
            ...
            if (V) {
                ...
                'kilometers' == af.widthAndHeightUnits &&
                    ((P = ad.kilometersToPixels(af.width)), (M = ad.kilometersToPixels(af.height)));
                'miles' == af.widthAndHeightUnits &&
                    ((P = ad.milesToPixels(af.width)), (M = ad.milesToPixels(af.height)));
                ...
                S = K = 0;
                af.centeredReal
                    ? (isNaN(af.right) || (K = P * s), isNaN(af.bottom) || (S = M * s))
                    : ((K = (P * s) / 2), (S = (M * s) / 2));
                O.translate(K, S, s, !0);
            } else {
                L
        ...
        createLine: function (aw, av) {
            ...
            if (aw.remainVisible || au.selectedObject == aw.parentObject) {
                ...
                isNaN(at.selectedBrightness) ||
                    (ac = a.adjustLuminosity(aw.colorReal, at.selectedBrightness / 100));
                aw.alphaReal = ai;
                ...
                if (0 < af.length) {
                    ...
                    if (isNaN(aj)) {
                        for (aj = 0; aj < af.length - 1; aj++) {
                            (T = Math.sqrt(
                                Math.pow(af[aj + 1] - af[aj], 2) + Math.pow(Y[aj + 1] - Y[aj], 2),
                            )),
                                (aw.distances[aj] = T);
                        }
                    ...
                    if ('none' != aa) {
                        ...
                        if ('end' == aa || 'both' == aa) {
                            (ag = af[af.length - 1]),
                                (X = Y[Y.length - 1]),
                                1 < af.length
                                    ? ((Z = af[af.length - 2]), (S = Y[Y.length - 2]))
                                    : ((Z = ag), (S = X)),
    ...
    a.MapImage = a.Class({
        ...
        animate: function () {
            ...
            this.line &&
                ...
                (this.line.distances &&
                    ((c = this.line.distances[this.lineSegment] * this.chart.zoomLevel()),
        ...
        delayAnimateAlong: function () {
            this.animateAlongLine &&
                (this.delayCounter = this.chart.imagesSettings.pauseDuration * a.updateRate);
        },
        fixToStage: function () {
        ...
        addObjects: function (h, e) {
            ...
            if (h.images) {
                for (j = 0; j < h.images.length; j++) {
                    (i = h.images[j]),
                        void 0 === i.showInList && (i.showInList = l.showImagesInList),
                        this.addObject(i, k);
                }
            }
            if (h.lines) {
                for (j = 0; j < h.lines.length; j++) {
                    (i = h.lines[j]),
                        void 0 === i.showInList && (i.showInList = l.showLinesInList),
                        this.addObject(i, k);
                }
            }
