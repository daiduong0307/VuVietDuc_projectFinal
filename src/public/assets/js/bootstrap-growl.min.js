...
(function (e, t, n, r) {
    var i = 'growl',
        ...
        o = {
            ...
            icon_type: 'class',
            template:
                '<div data-growl="container" class="alert" role="alert"><button type="button" aria-hidden="true" class="close" data-growl="dismiss">&times;</button><span data-growl="icon"></span><span data-growl="title"></span><span data-growl="message"></span><a href="#" data-growl="url"></a></div>',
        };
    var u = function (t, n) {
            o = e.extend(true, {}, o, n);
        },
        a = function (t) {
            if (!t) {
                e('[data-growl="container"]')
                    .find('[data-growl="dismiss"]')
                    .trigger('click');
            } else {
                e('[data-growl="container"][data-growl-position="' + t + '"]')
                    .find('[data-growl="dismiss"]')
                    .trigger('click');
            }
        },
        ...
        c = function (t) {
            ...
            n.attr(
                'data-growl-position',
                t.settings.placement.from + '-' + t.settings.placement.align
            );
        ...
        h = function (e, t) {
            ...
            if (t.content.icon) {
                if (t.icon_type.toLowerCase() == 'class') {
                    ...
                    if (e.find('[data-growl="icon"]').is('img')) {
                        e.find('[data-growl="icon"]').attr(
                            'src',
                            t.content.icon
                        );
                    } else {
                        e.find('[data-growl="icon"]').append(
                            '<img src="' + t.content.icon + '" />'
                        );
                    }
                }
            }
            ...
            if (t.content.url) {
                e.find('[data-growl="url"]')
                    .attr('href', t.content.url)
                    .attr('target', t.url_target);
        ...
        p = function (t, n) {
            ...
            e(
                ...
                return (r = Math.max(
                    r,
                    parseInt(e(this).css(n.placement.from)) +
                        e(this).outerHeight() +
                        n.spacing
                ));
            });
        ...
        d = function (e, t, n) {
            ...
            if (t.delay >= 1) {
                ...
                var r = setInterval(function () {
                    ...
                    if (
                        (!e.hasClass('hovering') && t.mouse_over == 'pause') ||
                        t.mouse_over != 'pause'
                    ) {
            ...
            switch (e) {
                case 'icon':
                    if (this.settings.icon_type.toLowerCase() == 'class') {
                        this.$template
                            .find('[data-growl="icon"]')
                            .removeClass(this.settings.content.icon);
                        this.$template.find('[data-growl="icon"]').addClass(t);
                    } else {
                        if (
                            this.$template.find('[data-growl="icon"]').is('img')
                        ) {
