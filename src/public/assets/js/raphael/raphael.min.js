            ...
            (i = [r(2)]),
                (n = function (t) {
                    function e(r) {
                        ...
                        if (e.is(r, Q))
                            return e._engine.create[z](e, r.splice(0, 3 + e.is(r[0], $))).add(r);
                    ...
                    function d(t, r, i) {
                        ...
                        for (
                            var n, a, s, o, l, h, u, c, f, d, g = i ? 0 : [], v = 0, x = t.length;
                            v < x;
                            v++
                        ) {
                            var y = t[v];
                    ...
                    (e.getRGB = n(function (t) {
                        ...
                        (e.rgb = n(function (t, e, r) {
                            ...
                            return (
                                '#' +
                                (16777216 | i(r) | (i(e) << 8) | (i(t) << 16)).toString(16).slice(1)
                            );
                        })),
                    ...
                    var Ot = (e.pathBBox = function (t) {
                        ...
                        Zt = n(function (t, e, r, i, n, a, s, o) {
                            ...
                            return (
                                ...
                                c > 0 &&
                                    c < 1 &&
                                    ((g = $t(t, e, r, i, n, a, s, o, c)), d.push(g.x), p.push(g.y)),
                                f > 0 &&
                                    f < 1 &&
                                    ((g = $t(t, e, r, i, n, a, s, o, f)), d.push(g.x), p.push(g.y)),
                                (l = a - 2 * i + e - (o - 2 * a + i)),
                                (h = 2 * (i - e) - 2 * (a - i)),
                                (u = e - i),
                                (c = (-h + Y.sqrt(h * h - 4 * l * u)) / 2 / l),
                        ...
                        le = (e._equaliseTransform = function (t, r) {
                            ...
                            for (
                                var i = W(t.length, r.length), n = [], a = [], s = 0, o, l, h, u;
                                s < i;
                                s++
                            ) {
                                if (
                    ...
                    (e._getContainer = function (t, r, i, n) {
                        var a;
                        if (
                            ((a = null != n || e.is(t, 'object') ? t : T.doc.getElementById(t)),
                            null != a)
                        )
                            return a.tagName
                                ? null == r
                                ...
                                for (
                                    ...
                                    if (((s = ge[o]), F && e.touches)) {
                                        for (var l = e.touches.length, h; l--; )
                                            if (
                                                ((h = e.touches[l]), h.identifier == s.el._drag.id)
                                            ) {
                                                (r = h.clientX),
                                                    (i = h.clientY),
                                                    (e.originalEvent
                                                ...
                                                if (l[A](y)) {
                                                    switch (pt[y]) {
                                                        ...
                                                        case 'path':
                                                            d = [];
                                                            for (
                                                                var m = 0, _ = l[y].length;
                                                                m < _;
                                                                m++
                                                            ) {
                                                                d[m] = [l[y][m][0]];
                                                                for (
                                                                    var w = 1, k = l[y][m].length;
                                                                    w < k;
                                                                    w++
                                                                )
                                                                    d[m][w] =
                    ...
                    (ye.animateWith = function (t, r, i, n, a, s) {
                        ...
                        (e.animation = function (t, r, i, n) {
                            ...
                            if (s)
                                return (
                                    i && (a.easing = i), n && (a.callback = n), new m({ 100: a }, r)
                                );
                            if (n) {
                                var l = 0;
                                for (var h in t) {
                        ...
                        (ye.pause = function (e) {
                            for (var r = 0; r < Ee.length; r++)
                                Ee[r].el.id != this.id ||
                                    (e && Ee[r].anim != e) ||
                                    (t('raphael.anim.pause.' + this.id, this, Ee[r].anim) !== !1 &&
                                        (Ee[r].paused = !0));
                            return this;
                        }),
            ...
            !(function (r) {
                ...
                (eve = function (t, e) {
                    ...
                    (eve.on = function (t, e) {
                        ...
                        for (
                            var r = m(t) ? (m(t[0]) ? t : [t]) : y(t).split(l), i = 0, n = r.length;
                            i < n;
                            i++
                        )
                            !(function (t) {
                                for (
                                    var r = m(t) ? t : y(t).split(o), i = d, n, a = 0, s = r.length;
                                    a < s;
                                    a++
                                )
                                    (i = i.n),
                    ...
                    if (!t || t.svg) {
                        ...
                        var v = function (i, n) {
                                if (n) {
                                    ...
                                    (i = t._g.doc.createElementNS('http://www.w3.org/2000/svg', i)),
                                        i.style &&
                        ...
                        (T.prototype = E),
                            ...
                            (E.rotate = function (t, e, n) {
                                ...
                                return (
                                    this.transform(this._.transform.concat([['r', t, e, n]])), this
                                );
                            }),
                        ...
                        (E.prototype = M),
                            ...
                            (M.transform = function (e) {
                                ...
                                var i = this.paper._viewBoxShift,
                                    ...
                                    a;
                                i && (a = e = r(e).replace(/\.{3}|\u2026/g, this._.transform || d)),
                            ...
                            (M.attr = function (r, i) {
                                ...
                                if (null == i && t.is(r, 'string')) {
                                    if (r == h && 'none' == this.attrs.fill && this.attrs.gradient)
                                        return this.attrs.gradient;
                                    for (
