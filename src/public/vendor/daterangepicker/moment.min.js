...
!(function (a, b) {
    ...
    function C(a) {
        for (var b, c, d, e, f = 0; f < a.length; ) {
            for (
                e = B(a[f]).split('-'), b = e.length, c = B(a[f + 1]), c = c ? c.split('-') : null;
                b > 0;
              ...
              null != nd[a]
                  ...
                  : null != b.parentLocale &&
                    (null != nd[b.parentLocale]
                        ...
                        : v('parentLocaleUndefined', 'specified parentLocale is not defined yet')),
              (nd[a] = new A(b)),
              E(a),
              nd[a])
            : (delete nd[a], null);
    ...
    function ea(a, b, c) {
        ...
        return c
            ...
            ? ((e = md.call(this._shortMonthsParse, g)),
              -1 !== e ? e : ((e = md.call(this._longMonthsParse, g)), -1 !== e ? e : null))
            : ((e = md.call(this._longMonthsParse, g)),
              -1 !== e ? e : ((e = md.call(this._shortMonthsParse, g)), -1 !== e ? e : null));
    }
    function fa(a, b, c) {
        var d, e, f;
    ...
    function oa(b) {
        ...
        return null !== c
            ...
            : (na(b),
              void (b._isValid === !1 && (delete b._isValid, a.createFromInputFallback(b))));
    }
    ...
    function Ba(a) {
        ...
        (b = a._w),
            ...
            1 > d || d > xa(c, f, g)
                ...
                : ((h = va(c, d, e, f, g)), (a._a[Md] = h.year), (a._dayOfYear = h.dayOfYear));
    }
    function Ca(b) {
    ...
    function Ua(b, c) {
        ...
        return this.isValid()
            ? null != b
                ? ('string' == typeof b ? (b = Ra(Hd, b)) : Math.abs(b) < 16 && (b = 60 * b),
    ...
    function Xa(a) {
        return (
            this._isUTC &&
                (this.utcOffset(0, a), (this._isUTC = !1), a && this.subtract(Ta(this), 'm')),
            this
        );
    }
    function Ya() {
    ...
    function gb(a, b) {
        ...
        return a.isValid() && b.isValid()
            ? ((b = Sa(b, a)),
              a.isBefore(b)
                  ? (c = fb(a, b))
                  : ((c = fb(b, a)), (c.milliseconds = -c.milliseconds), (c.months = -c.months)),
              c)
            ...
            ? ((e = md.call(this._weekdaysParse, g)),
              -1 !== e
                  ...
                  : ((e = md.call(this._shortWeekdaysParse, g)),
                    -1 !== e ? e : ((e = md.call(this._minWeekdaysParse, g)), -1 !== e ? e : null)))
            : 'ddd' === b
            ? ((e = md.call(this._shortWeekdaysParse, g)),
              -1 !== e
                  ? e
    ...
    function Wc(a) {
        ...
        if (((a = K(a)), 'month' === a || 'year' === a))
            return (
                (b = this._days + d / 864e5), (c = this._months + Uc(b)), 'month' === a ? c : c / 12
            );
