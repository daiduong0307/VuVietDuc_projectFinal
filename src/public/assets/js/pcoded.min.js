$.fn.pcodedmenu = function (settings) {
    ...
    var PcodedMenu = {
        ...
        HandleHorizontalItemAlignment: function () {
            ...
            if (layout === 'horizontal') {
                ...
                function rightitemalignment() {
                    var elm = $(
                        '#' + oid + '.pcoded .pcoded-navbar .pcoded-item.pcoded-right-item',
                    );
            ...
            switch (settings.themelayout) {
                case 'vertical':
                    if (navposition == true) {
                        ...
                        $('#' + oid + ' .pcoded-header .pcoded-left-header').attr(
        ...
        HandleMenuOnClick: function () {
            ...
            if (settings.themelayout === 'vertical') {
                $('#mobile-collapse,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a').on(
                    'click',
                    function () {
